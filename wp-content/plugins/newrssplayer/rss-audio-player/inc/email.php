...
if ($res)
	echo '<center><h3 style="color:green">Email Sent</h3></center>';
else
	echo '<center><h3 style="color:red">Sending failure, Please Try Again</h3></center>';
}
else {

    echo '<center><h3 style="color:red">You didn\'t provide a valid email.</h3></center>';
}
