...
<div id="displet-property-details" class="<?php displetretsidx_the_default_styles_class(); ?> <?php displetretsidx_the_color_scheme_class(); ?> displet-selectively-styled">
	...
	<div class="displet-group">
		<?php if ( displetretsidx_use_planwise_affordability() ) : ?>
			<div class="displet-planwise">
				<?php displetretsidx_the_planwise_container(); ?>
			</div>
		<?php endif; ?>
		<div class="displet-styles">
			<?php if ( displetretsidx_has_photo_urls() ) : ?>
		...
		<div class="displet-details-section">
			<?php if ( !empty( $displet_pdp_basic ) ) : ?>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_basic_left = array_slice( $displet_pdp_basic, 0, ceil( count( $displet_pdp_basic ) / 2 ) );
									if ( !empty( $displet_pdp_basic_left ) ) foreach ( $displet_pdp_basic_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_basic_right = array_slice( $displet_pdp_basic, ceil( count( $displet_pdp_basic ) / 2 ) );
									if ( !empty( $displet_pdp_basic_right ) ) foreach ( $displet_pdp_basic_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_interior_left = array_slice( $displet_pdp_interior, 0, ceil( count( $displet_pdp_interior ) / 2 ) );
									if ( !empty( $displet_pdp_interior_left ) ) foreach ( $displet_pdp_interior_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_interior_right = array_slice( $displet_pdp_interior, ceil( count( $displet_pdp_interior ) / 2 ) );
									if ( !empty( $displet_pdp_interior_right ) ) foreach ( $displet_pdp_interior_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_exterior_left = array_slice( $displet_pdp_exterior, 0, ceil( count( $displet_pdp_exterior ) / 2 ) );
									if ( !empty( $displet_pdp_exterior_left ) ) foreach ( $displet_pdp_exterior_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_exterior_right = array_slice( $displet_pdp_exterior, ceil( count( $displet_pdp_exterior ) / 2 ) );
									if ( !empty( $displet_pdp_exterior_right ) ) foreach ( $displet_pdp_exterior_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_area_left = array_slice( $displet_pdp_area, 0, ceil( count( $displet_pdp_area ) / 2 ) );
									if ( !empty( $displet_pdp_area_left ) ) foreach ( $displet_pdp_area_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_area_right = array_slice( $displet_pdp_area, ceil( count( $displet_pdp_area ) / 2 ) );
									if ( !empty( $displet_pdp_area_right ) ) foreach ( $displet_pdp_area_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_school_left = array_slice( $displet_pdp_school, 0, ceil( count( $displet_pdp_school ) / 2 ) );
									if ( !empty( $displet_pdp_school_left ) ) foreach ( $displet_pdp_school_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_school_right = array_slice( $displet_pdp_school, ceil( count( $displet_pdp_school ) / 2 ) );
									if ( !empty( $displet_pdp_school_right ) ) foreach ( $displet_pdp_school_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_tax_left = array_slice( $displet_pdp_tax, 0, ceil( count( $displet_pdp_tax ) / 2 ) );
									if ( !empty( $displet_pdp_tax_left ) ) foreach ( $displet_pdp_tax_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_tax_right = array_slice( $displet_pdp_tax, ceil( count( $displet_pdp_tax ) / 2 ) );
									if ( !empty( $displet_pdp_tax_right ) ) foreach ( $displet_pdp_tax_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
				...
				<table class="displet-details">
					<tr>
						<td class="displet-details-first">
							<table>
								<?php
									$displet_pdp_other_left = array_slice( $displet_pdp_other, 0, ceil( count( $displet_pdp_other ) / 2 ) );
									if ( !empty( $displet_pdp_other_left ) ) foreach ( $displet_pdp_other_left as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
						<td class="displet-details-second">
							<table>
								<?php
									$displet_pdp_other_right = array_slice( $displet_pdp_other, ceil( count( $displet_pdp_other ) / 2 ) );
									if ( !empty( $displet_pdp_other_right ) ) foreach ( $displet_pdp_other_right as $displet_pdp_html ) echo $displet_pdp_html;
								?>
							</table>
						</td>
					</tr>
