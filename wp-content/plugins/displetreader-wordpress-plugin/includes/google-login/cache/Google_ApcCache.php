 ...
 */
class googleApcCache extends displetretsidx_Google_Cache {

  public function __construct() {
    if (! function_exists('apc_add')) {
      throw new displetretsidx_Google_CacheException("Apc functions not available");
    }
  }
  ...
  public function set($key, $value) {
    if (@apc_store($key, array('time' => time(), 'data' => serialize($value))) == false) {
      throw new displetretsidx_Google_CacheException("Couldn't store data");
    }
  }
