 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $shoppingService = new displetretsidx_Google_ShoppingService(...);
   *   $products = $shoppingService->products;
   *  </code>
   */
  class displetretsidx_Google_ProductsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Products
     */
    public function listProducts($source, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Products($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Product
     */
    public function get($source, $accountId, $productIdType, $productId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Product($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Shopping (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_ShoppingService extends displetretsidx_Google_Service {
  public $products;
  /**
...
class displetretsidx_Google_Product extends displetretsidx_Google_Model {
  ...
  public function setProduct(displetretsidx_Google_ShoppingModelProductJsonV1 $product) {
  ...
  public function setRecommendations(/* array(displetretsidx_Google_ShoppingModelRecommendationsJsonV1) */ $recommendations) {
    $this->assertIsArray($recommendations, 'displetretsidx_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
    $this->recommendations = $recommendations;
  }
  public function getRecommendations() {
    return $this->recommendations;
  }
  public function setDebug(displetretsidx_Google_ShoppingModelDebugJsonV1 $debug) {
    $this->debug = $debug;
  }
  ...
  public function setCategories(/* array(displetretsidx_Google_ShoppingModelCategoryJsonV1) */ $categories) {
    $this->assertIsArray($categories, 'displetretsidx_Google_ShoppingModelCategoryJsonV1', __METHOD__);
...
class displetretsidx_Google_Products extends displetretsidx_Google_Model {
  protected $__promotionsType = 'displetretsidx_Google_ProductsPromotions';
  protected $__promotionsDataType = 'array';
  public $promotions;
  public $selfLink;
  public $kind;
  protected $__storesType = 'displetretsidx_Google_ProductsStores';
  protected $__storesDataType = 'array';
  public $stores;
  public $currentItemCount;
  protected $__itemsType = 'displetretsidx_Google_Product';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__facetsType = 'displetretsidx_Google_ProductsFacets';
  ...
  public $etag;
  public $requestId;
  protected $__categoryRecommendationsType = 'displetretsidx_Google_ShoppingModelRecommendationsJsonV1';
  protected $__categoryRecommendationsDataType = 'array';
  public $categoryRecommendations;
  protected $__debugType = 'displetretsidx_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  protected $__spellingType = 'displetretsidx_Google_ProductsSpelling';
  ...
  protected $__categoriesDataType = 'array';
  public $categories;
  public function setPromotions(/* array(displetretsidx_Google_ProductsPromotions) */ $promotions) {
    $this->assertIsArray($promotions, 'displetretsidx_Google_ProductsPromotions', __METHOD__);
  ...
  public function setStores(/* array(displetretsidx_Google_ProductsStores) */ $stores) {
    $this->assertIsArray($stores, 'displetretsidx_Google_ProductsStores', __METHOD__);
    $this->stores = $stores;
  }
  ...
  public function setItems(/* array(displetretsidx_Google_Product) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Product', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setFacets(/* array(displetretsidx_Google_ProductsFacets) */ $facets) {
    $this->assertIsArray($facets, 'displetretsidx_Google_ProductsFacets', __METHOD__);
    $this->facets = $facets;
  }
  ...
  public function setRedirects(/* array(displetretsidx_Google_string) */ $redirects) {
    $this->assertIsArray($redirects, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setRelatedQueries(/* array(displetretsidx_Google_string) */ $relatedQueries) {
    $this->assertIsArray($relatedQueries, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setCategoryRecommendations(/* array(displetretsidx_Google_ShoppingModelRecommendationsJsonV1) */ $categoryRecommendations) {
    $this->assertIsArray($categoryRecommendations, 'displetretsidx_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
  ...
  public function setSpelling(displetretsidx_Google_ProductsSpelling $spelling) {
...
class displetretsidx_Google_ProductsFacets extends displetretsidx_Google_Model {
  public $count;
  public $displayName;
  public $name;
  protected $__bucketsType = 'displetretsidx_Google_ProductsFacetsBuckets';
  ...
  public function setBuckets(/* array(displetretsidx_Google_ProductsFacetsBuckets) */ $buckets) {
    $this->assertIsArray($buckets, 'displetretsidx_Google_ProductsFacetsBuckets', __METHOD__);
...
class displetretsidx_Google_ProductsFacetsBuckets extends displetretsidx_Google_Model {
  public $count;
  public $minExclusive;
  public $min;
  public $max;
...
class displetretsidx_Google_ProductsPromotions extends displetretsidx_Google_Model {
  protected $__productType = 'displetretsidx_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $description;
  ...
  public $destLink;
  public $customHtml;
  protected $__customFieldsType = 'displetretsidx_Google_ProductsPromotionsCustomFields';
  ...
  public function setCustomFields(/* array(displetretsidx_Google_ProductsPromotionsCustomFields) */ $customFields) {
    $this->assertIsArray($customFields, 'displetretsidx_Google_ProductsPromotionsCustomFields', __METHOD__);
...
class displetretsidx_Google_ProductsPromotionsCustomFields extends displetretsidx_Google_Model {
  public $name;
  public $value;
  public function setName($name) {
    $this->name = $name;
...
class displetretsidx_Google_ProductsSpelling extends displetretsidx_Google_Model {
  public $suggestion;
...
class displetretsidx_Google_ProductsStores extends displetretsidx_Google_Model {
  public $storeCode;
  public $name;
  public $storeName;
  public $storeId;
...
class displetretsidx_Google_ShoppingModelCategoryJsonV1 extends displetretsidx_Google_Model {
  public $url;
  public $shortName;
  public $parents;
  public $id;
  ...
  public function setParents(/* array(displetretsidx_Google_string) */ $parents) {
    $this->assertIsArray($parents, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_ShoppingModelDebugJsonV1 extends displetretsidx_Google_Model {
  ...
  protected $__backendTimesType = 'displetretsidx_Google_ShoppingModelDebugJsonV1BackendTimes';
  ...
  public function setBackendTimes(/* array(displetretsidx_Google_ShoppingModelDebugJsonV1BackendTimes) */ $backendTimes) {
    $this->assertIsArray($backendTimes, 'displetretsidx_Google_ShoppingModelDebugJsonV1BackendTimes', __METHOD__);
...
class displetretsidx_Google_ShoppingModelDebugJsonV1BackendTimes extends displetretsidx_Google_Model {
  public $serverMillis;
  public $hostName;
  public $name;
  public $elapsedMillis;
...
class displetretsidx_Google_ShoppingModelProductJsonV1 extends displetretsidx_Google_Model {
  public $queryMatched;
  public $gtin;
  protected $__imagesType = 'displetretsidx_Google_ShoppingModelProductJsonV1Images';
  protected $__imagesDataType = 'array';
  public $images;
  protected $__inventoriesType = 'displetretsidx_Google_ShoppingModelProductJsonV1Inventories';
  protected $__inventoriesDataType = 'array';
  public $inventories;
  protected $__authorType = 'displetretsidx_Google_ShoppingModelProductJsonV1Author';
  ...
  public $brand;
  public $internal3;
  protected $__internal4Type = 'displetretsidx_Google_ShoppingModelProductJsonV1Internal4';
  ...
  public $link;
  public $mpns;
  protected $__attributesType = 'displetretsidx_Google_ShoppingModelProductJsonV1Attributes';
  protected $__attributesDataType = 'array';
  public $attributes;
  public $totalMatchingVariants;
  protected $__variantsType = 'displetretsidx_Google_ShoppingModelProductJsonV1Variants';
  ...
  public function setImages(/* array(displetretsidx_Google_ShoppingModelProductJsonV1Images) */ $images) {
    $this->assertIsArray($images, 'displetretsidx_Google_ShoppingModelProductJsonV1Images', __METHOD__);
    $this->images = $images;
  }
  public function getImages() {
    return $this->images;
  }
  public function setInventories(/* array(displetretsidx_Google_ShoppingModelProductJsonV1Inventories) */ $inventories) {
    $this->assertIsArray($inventories, 'displetretsidx_Google_ShoppingModelProductJsonV1Inventories', __METHOD__);
    $this->inventories = $inventories;
  }
  public function getInventories() {
    return $this->inventories;
  }
  public function setAuthor(displetretsidx_Google_ShoppingModelProductJsonV1Author $author) {
    $this->author = $author;
  }
  ...
  public function setInternal8(/* array(displetretsidx_Google_string) */ $internal8) {
    $this->assertIsArray($internal8, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setGtins(/* array(displetretsidx_Google_string) */ $gtins) {
    $this->assertIsArray($gtins, 'displetretsidx_Google_string', __METHOD__);
    $this->gtins = $gtins;
  }
  public function getGtins() {
    return $this->gtins;
  }
  public function setInternal1(/* array(displetretsidx_Google_string) */ $internal1) {
    $this->assertIsArray($internal1, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setInternal4(/* array(displetretsidx_Google_ShoppingModelProductJsonV1Internal4) */ $internal4) {
    $this->assertIsArray($internal4, 'displetretsidx_Google_ShoppingModelProductJsonV1Internal4', __METHOD__);
  ...
  public function setMpns(/* array(displetretsidx_Google_string) */ $mpns) {
    $this->assertIsArray($mpns, 'displetretsidx_Google_string', __METHOD__);
    $this->mpns = $mpns;
  }
  public function getMpns() {
    return $this->mpns;
  }
  public function setAttributes(/* array(displetretsidx_Google_ShoppingModelProductJsonV1Attributes) */ $attributes) {
    $this->assertIsArray($attributes, 'displetretsidx_Google_ShoppingModelProductJsonV1Attributes', __METHOD__);
  ...
  public function setVariants(/* array(displetretsidx_Google_ShoppingModelProductJsonV1Variants) */ $variants) {
    $this->assertIsArray($variants, 'displetretsidx_Google_ShoppingModelProductJsonV1Variants', __METHOD__);
  ...
  public function setInternal10(/* array(displetretsidx_Google_string) */ $internal10) {
    $this->assertIsArray($internal10, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_ShoppingModelProductJsonV1Attributes extends displetretsidx_Google_Model {
  public $type;
  public $value;
  public $displayName;
  public $name;
...
class displetretsidx_Google_ShoppingModelProductJsonV1Author extends displetretsidx_Google_Model {
  public $name;
  public $accountId;
  public function setName($name) {
    $this->name = $name;
...
class displetretsidx_Google_ShoppingModelProductJsonV1Images extends displetretsidx_Google_Model {
  public $status;
  public $link;
  protected $__thumbnailsType = 'displetretsidx_Google_ShoppingModelProductJsonV1ImagesThumbnails';
  ...
  public function setThumbnails(/* array(displetretsidx_Google_ShoppingModelProductJsonV1ImagesThumbnails) */ $thumbnails) {
    $this->assertIsArray($thumbnails, 'displetretsidx_Google_ShoppingModelProductJsonV1ImagesThumbnails', __METHOD__);
...
class displetretsidx_Google_ShoppingModelProductJsonV1ImagesThumbnails extends displetretsidx_Google_Model {
  public $content;
  public $width;
  public $link;
  public $height;
...
class displetretsidx_Google_ShoppingModelProductJsonV1Internal4 extends displetretsidx_Google_Model {
  public $node;
  public $confidence;
...
class displetretsidx_Google_ShoppingModelProductJsonV1Inventories extends displetretsidx_Google_Model {
...
class displetretsidx_Google_ShoppingModelProductJsonV1Variants extends displetretsidx_Google_Model {
  protected $__variantType = 'displetretsidx_Google_ShoppingModelProductJsonV1';
  protected $__variantDataType = '';
  public $variant;
  public function setVariant(displetretsidx_Google_ShoppingModelProductJsonV1 $variant) {
...
class displetretsidx_Google_ShoppingModelRecommendationsJsonV1 extends displetretsidx_Google_Model {
  protected $__recommendationListType = 'displetretsidx_Google_ShoppingModelRecommendationsJsonV1RecommendationList';
  protected $__recommendationListDataType = 'array';
  public $recommendationList;
  public $type;
  public function setRecommendationList(/* array(displetretsidx_Google_ShoppingModelRecommendationsJsonV1RecommendationList) */ $recommendationList) {
    $this->assertIsArray($recommendationList, 'displetretsidx_Google_ShoppingModelRecommendationsJsonV1RecommendationList', __METHOD__);
...
class displetretsidx_Google_ShoppingModelRecommendationsJsonV1RecommendationList extends displetretsidx_Google_Model {
  protected $__productType = 'displetretsidx_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public function setProduct(displetretsidx_Google_ShoppingModelProductJsonV1 $product) {
