 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $orkutService = new displetretsidx_Google_OrkutService(...);
   *   $communityMembers = $orkutService->communityMembers;
   *  </code>
   */
  class displetretsidx_Google_CommunityMembersServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_CommunityMembers
     */
    public function insert($communityId, $userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityMembers($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityMembersList
     */
    public function listCommunityMembers($communityId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityMembersList($data);
      } else {
        return $data;
      }
    }
  ...
  class displetretsidx_Google_ActivitiesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_ActivityList
     */
    public function listActivities($userId, $collection, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_ActivityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityPollCommentsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_CommunityPollComment $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_CommunityPollComment
     */
    public function insert($communityId, $pollId, displetretsidx_Google_CommunityPollComment $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityPollComment($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityPollCommentList
     */
    public function listCommunityPollComments($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityPollCommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityPollsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityPollList
     */
    public function listCommunityPolls($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityPollList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityPoll
     */
    public function get($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityPoll($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityMessagesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_CommunityMessage $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_CommunityMessage
     */
    public function insert($communityId, $topicId, displetretsidx_Google_CommunityMessage $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'topicId' => $topicId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityMessage($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityMessageList
     */
    public function listCommunityMessages($communityId, $topicId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityMessageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityTopicsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_CommunityTopic $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool isShout Whether this topic is a shout.
     * @return displetretsidx_Google_CommunityTopic
     */
    public function insert($communityId, displetretsidx_Google_CommunityTopic $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityTopic($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityTopicList
     */
    public function listCommunityTopics($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityTopicList($data);
      } else {
        return $data;
      }
    }
  ...
  class displetretsidx_Google_CommentsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Comment $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Comment
     */
    public function insert($activityId, displetretsidx_Google_Comment $postBody, $optParams = array()) {
     ...
     * @opt_param string maxResults The maximum number of activities to include in the response.
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommentList
     */
    public function listComments($activityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_AclServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityRelatedServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_CommunityList
     */
    public function listCommunityRelated($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_ScrapsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     */
    public function insert(displetretsidx_Google_Activity $postBody, $optParams = array()) {
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityPollVotesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_CommunityPollVote $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_CommunityPollVote
     */
    public function insert($communityId, $pollId, displetretsidx_Google_CommunityPollVote $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CommunityPollVote($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunitiesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return displetretsidx_Google_Community
     */
    public function get($communityId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Community($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CommunityFollowServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_ActivityVisibilityServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @param string $activityId ID of the activity.
     * @param displetretsidx_Google_Visibility $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Visibility
     */
    public function patch($activityId, displetretsidx_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Visibility($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Visibility
     */
    public function update($activityId, displetretsidx_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_BadgesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_BadgeList
     */
    public function listBadges($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_BadgeList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Badge
     */
    public function get($userId, $badgeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Badge($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_CountersServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Counters
     */
    public function listCounters($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Counters($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Orkut (v2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_OrkutService extends displetretsidx_Google_Service {
...
class displetretsidx_Google_AclItems extends displetretsidx_Google_Model {
  public $type;
  public $id;
...
class displetretsidx_Google_Activity extends displetretsidx_Google_Model {
  public $kind;
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  ...
  public $object;
  public $updated;
  protected $__actorType = 'displetretsidx_Google_OrkutAuthorResource';
  ...
  public function setLinks(/* array(displetretsidx_Google_OrkutLinkResource) */ $links) {
    $this->assertIsArray($links, 'displetretsidx_Google_OrkutLinkResource', __METHOD__);
    $this->links = $links;
  }
  ...
  public function setActor(displetretsidx_Google_OrkutAuthorResource $actor) {
    $this->actor = $actor;
  }
...
class displetretsidx_Google_ActivityList extends displetretsidx_Google_Model {
...
class displetretsidx_Google_ActivityObject extends displetretsidx_Google_Model {
  public $content;
  protected $__itemsType = 'displetretsidx_Google_OrkutActivityobjectsResource';
  protected $__itemsDataType = 'array';
  public $items;
  ...
  public function setItems(/* array(displetretsidx_Google_OrkutActivityobjectsResource) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_OrkutActivityobjectsResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Badge extends displetretsidx_Google_Model {
...
class displetretsidx_Google_BadgeList extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Badge';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Badge) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Badge', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Comment extends displetretsidx_Google_Model {
  ...
  public $published;
  public $id;
  public function setInReplyTo(displetretsidx_Google_CommentInReplyTo $inReplyTo) {
...
class displetretsidx_Google_CommentList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class displetretsidx_Google_Community extends displetretsidx_Google_Model {
  public $category;
  public $kind;
  public $member_count;
  public $description;
  ...
  protected $__ownerType = 'displetretsidx_Google_OrkutAuthorResource';
  protected $__ownerDataType = '';
  public $owner;
  protected $__moderatorsType = 'displetretsidx_Google_OrkutAuthorResource';
  protected $__moderatorsDataType = 'array';
  public $moderators;
  public $location;
  protected $__co_ownersType = 'displetretsidx_Google_OrkutAuthorResource';
  ...
  public function setOwner(displetretsidx_Google_OrkutAuthorResource $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  }
  public function setModerators(/* array(displetretsidx_Google_OrkutAuthorResource) */ $moderators) {
    $this->assertIsArray($moderators, 'displetretsidx_Google_OrkutAuthorResource', __METHOD__);
  ...
  public function setCo_owners(/* array(displetretsidx_Google_OrkutAuthorResource) */ $co_owners) {
    $this->assertIsArray($co_owners, 'displetretsidx_Google_OrkutAuthorResource', __METHOD__);
...
class displetretsidx_Google_CommunityList extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Community';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Community) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Community', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_CommunityMembers extends displetretsidx_Google_Model {
  protected $__communityMembershipStatusType = 'displetretsidx_Google_CommunityMembershipStatus';
  protected $__communityMembershipStatusDataType = '';
  public $communityMembershipStatus;
  protected $__personType = 'displetretsidx_Google_OrkutActivitypersonResource';
  protected $__personDataType = '';
  public $person;
  public $kind;
  public function setCommunityMembershipStatus(displetretsidx_Google_CommunityMembershipStatus $communityMembershipStatus) {
  ...
  public function setPerson(displetretsidx_Google_OrkutActivitypersonResource $person) {
    $this->person = $person;
  }
...
class displetretsidx_Google_CommunityMembersList extends displetretsidx_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'displetretsidx_Google_CommunityMembers';
  protected $__itemsDataType = 'array';
  public $items;
  ...
  public function setItems(/* array(displetretsidx_Google_CommunityMembers) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_CommunityMembers', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_CommunityMembershipStatus extends displetretsidx_Google_Model {
  public $status;
  public $isFollowing;
...
class displetretsidx_Google_CommunityMessage extends displetretsidx_Google_Model {
  public $body;
  public $kind;
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__authorType = 'displetretsidx_Google_OrkutAuthorResource';
  ...
  public function setAuthor(displetretsidx_Google_OrkutAuthorResource $author) {
    $this->author = $author;
  }
...
class displetretsidx_Google_CommunityMessageList extends displetretsidx_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'displetretsidx_Google_CommunityMessage';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_CommunityMessage) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_CommunityMessage', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_CommunityPoll extends displetretsidx_Google_Model {
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  public $isMultipleAnswers;
  protected $__imageType = 'displetretsidx_Google_CommunityPollImage';
  ...
  public $kind;
  public $creationTime;
  protected $__optionsType = 'displetretsidx_Google_OrkutCommunitypolloptionResource';
  ...
  public function setImage(displetretsidx_Google_CommunityPollImage $image) {
    $this->image = $image;
  }
  ...
  public function setVotedOptions(/* array(displetretsidx_Google_int) */ $votedOptions) {
    $this->assertIsArray($votedOptions, 'displetretsidx_Google_int', __METHOD__);
  ...
  public function setOptions(/* array(displetretsidx_Google_OrkutCommunitypolloptionResource) */ $options) {
    $this->assertIsArray($options, 'displetretsidx_Google_OrkutCommunitypolloptionResource', __METHOD__);
...
class displetretsidx_Google_CommunityPollComment extends displetretsidx_Google_Model {
  public $body;
  public $kind;
  public $addedDate;
  public $id;
...
class displetretsidx_Google_CommunityPollCommentList extends displetretsidx_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'displetretsidx_Google_CommunityPollComment';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_CommunityPollComment) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_CommunityPollComment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_CommunityPollImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_CommunityPollList extends displetretsidx_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'displetretsidx_Google_CommunityPoll';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_CommunityPoll) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_CommunityPoll', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_CommunityPollVote extends displetretsidx_Google_Model {
  public $kind;
  public $optionIds;
  ...
  public function setOptionIds(/* array(displetretsidx_Google_int) */ $optionIds) {
    $this->assertIsArray($optionIds, 'displetretsidx_Google_int', __METHOD__);
...
class displetretsidx_Google_CommunityTopic extends displetretsidx_Google_Model {
  public $body;
  public $lastUpdate;
  public $kind;
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  ...
  public $author;
  public $title;
  protected $__messagesType = 'displetretsidx_Google_CommunityMessage';
  ...
  public function setMessages(/* array(displetretsidx_Google_CommunityMessage) */ $messages) {
    $this->assertIsArray($messages, 'displetretsidx_Google_CommunityMessage', __METHOD__);
...
class displetretsidx_Google_CommunityTopicList extends displetretsidx_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'displetretsidx_Google_CommunityTopic';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_CommunityTopic) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_CommunityTopic', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Counters extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_OrkutCounterResource';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_OrkutCounterResource) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_OrkutCounterResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_OrkutActivityobjectsResource extends displetretsidx_Google_Model {
  public $displayName;
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__communityType = 'displetretsidx_Google_Community';
  ...
  public function setCommunity(displetretsidx_Google_Community $community) {
...
class displetretsidx_Google_OrkutActivitypersonResource extends displetretsidx_Google_Model {
  protected $__nameType = 'displetretsidx_Google_OrkutActivitypersonResourceName';
  protected $__nameDataType = '';
  public $name;
  public $url;
  public $gender;
  protected $__imageType = 'displetretsidx_Google_OrkutActivitypersonResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $birthday;
  public $id;
  public function setName(displetretsidx_Google_OrkutActivitypersonResourceName $name) {
    $this->name = $name;
  }
  public function getName() {
    return $this->name;
  ...
  public function setImage(displetretsidx_Google_OrkutActivitypersonResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class displetretsidx_Google_OrkutActivitypersonResourceImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_OrkutActivitypersonResourceName extends displetretsidx_Google_Model {
  public $givenName;
  public $familyName;
...
class displetretsidx_Google_OrkutAuthorResource extends displetretsidx_Google_Model {
  public $url;
  protected $__imageType = 'displetretsidx_Google_OrkutAuthorResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(displetretsidx_Google_OrkutAuthorResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class displetretsidx_Google_OrkutAuthorResourceImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_OrkutCommunitypolloptionResource extends displetretsidx_Google_Model {
  protected $__imageType = 'displetretsidx_Google_OrkutCommunitypolloptionResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $optionId;
  public $description;
  public $numberOfVotes;
  public function setImage(displetretsidx_Google_OrkutCommunitypolloptionResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class displetretsidx_Google_OrkutCommunitypolloptionResourceImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_OrkutCounterResource extends displetretsidx_Google_Model {
  public $total;
  protected $__linkType = 'displetretsidx_Google_OrkutLinkResource';
  ...
  public function setLink(displetretsidx_Google_OrkutLinkResource $link) {
    $this->link = $link;
  }
...
class displetretsidx_Google_OrkutLinkResource extends displetretsidx_Google_Model {
  public $href;
  public $type;
  public $rel;
  public $title;
...
class displetretsidx_Google_Visibility extends displetretsidx_Google_Model {
  public $kind;
  public $visibility;
  protected $__linksType = 'displetretsidx_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
