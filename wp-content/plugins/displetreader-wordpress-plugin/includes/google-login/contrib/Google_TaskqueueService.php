 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $taskqueueService = new displetretsidx_Google_TaskqueueService(...);
   *   $taskqueues = $taskqueueService->taskqueues;
   *  </code>
   */
  class displetretsidx_Google_TaskqueuesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_TaskQueue
     */
    public function get($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_TaskQueue($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_TasksServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Task $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Task
     */
    public function insert($project, $taskqueue, displetretsidx_Google_Task $postBody, $optParams = array()) {
      $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Task($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Tasks2
     */
    public function listTasks($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Tasks2($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Task
     */
    public function update($project, $taskqueue, $task, $newLeaseSeconds, displetretsidx_Google_Task $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Task
     */
    public function patch($project, $taskqueue, $task, $newLeaseSeconds, displetretsidx_Google_Task $postBody, $optParams = array()) {
      $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
     ...
     * @return displetretsidx_Google_Tasks
     */
    public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Tasks($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Taskqueue (v1beta2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_TaskqueueService extends displetretsidx_Google_Service {
  public $taskqueues;
  public $tasks;
  /**
...
class displetretsidx_Google_TaskQueue extends displetretsidx_Google_Model {
  public $kind;
  protected $__statsType = 'displetretsidx_Google_TaskQueueStats';
  protected $__statsDataType = '';
  public $stats;
  public $id;
  public $maxLeases;
  protected $__aclType = 'displetretsidx_Google_TaskQueueAcl';
  ...
  public function setStats(displetretsidx_Google_TaskQueueStats $stats) {
    $this->stats = $stats;
  }
  ...
  public function setAcl(displetretsidx_Google_TaskQueueAcl $acl) {
    $this->acl = $acl;
  }
...
class displetretsidx_Google_TaskQueueAcl extends displetretsidx_Google_Model {
  public $consumerEmails;
  public $producerEmails;
  public $adminEmails;
  public function setConsumerEmails(/* array(displetretsidx_Google_string) */ $consumerEmails) {
    $this->assertIsArray($consumerEmails, 'displetretsidx_Google_string', __METHOD__);
    $this->consumerEmails = $consumerEmails;
  }
  public function getConsumerEmails() {
    return $this->consumerEmails;
  }
  public function setProducerEmails(/* array(displetretsidx_Google_string) */ $producerEmails) {
    $this->assertIsArray($producerEmails, 'displetretsidx_Google_string', __METHOD__);
    $this->producerEmails = $producerEmails;
  }
  public function getProducerEmails() {
    return $this->producerEmails;
  }
  public function setAdminEmails(/* array(displetretsidx_Google_string) */ $adminEmails) {
    $this->assertIsArray($adminEmails, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_TaskQueueStats extends displetretsidx_Google_Model {
  public $oldestTask;
...
class displetretsidx_Google_Tasks extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Task) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Task', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_Tasks2 extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
