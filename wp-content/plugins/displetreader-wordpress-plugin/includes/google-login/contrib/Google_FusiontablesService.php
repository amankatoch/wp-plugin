 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $fusiontablesService = new displetretsidx_Google_FusiontablesService(...);
   *   $column = $fusiontablesService->column;
   *  </code>
   */
  class displetretsidx_Google_ColumnServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Column $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Column
     */
    public function insert($tableId, displetretsidx_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Column($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_ColumnList
     */
    public function listColumn($tableId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_ColumnList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Column
     */
    public function update($tableId, $columnId, displetretsidx_Google_Column $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Column
     */
    public function patch($tableId, $columnId, displetretsidx_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_QueryServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Sqlresponse
     */
    public function sqlGet($sql, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Sqlresponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_StyleServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_StyleSetting $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_StyleSetting
     */
    public function insert($tableId, displetretsidx_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_StyleSetting($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_StyleSettingList
     */
    public function listStyle($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_StyleSettingList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_StyleSetting
     */
    public function update($tableId, $styleId, displetretsidx_Google_StyleSetting $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_StyleSetting
     */
    public function patch($tableId, $styleId, displetretsidx_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class displetretsidx_Google_TemplateServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Template $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Template
     */
    public function insert($tableId, displetretsidx_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Template($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_TemplateList
     */
    public function listTemplate($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_TemplateList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Template
     */
    public function update($tableId, $templateId, displetretsidx_Google_Template $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Template
     */
    public function patch($tableId, $templateId, displetretsidx_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class displetretsidx_Google_TableServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     */
    public function insert(displetretsidx_Google_Table $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Table
     */
    public function update($tableId, displetretsidx_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return displetretsidx_Google_Table
     */
    public function patch($tableId, displetretsidx_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for displetretsidx_Google_Fusiontables (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_FusiontablesService extends displetretsidx_Google_Service {
  public $column;
  public $query;
  public $style;
  public $template;
...
class displetretsidx_Google_Column extends displetretsidx_Google_Model {
  public $kind;
  public $type;
  public $columnId;
  public $name;
  protected $__baseColumnType = 'displetretsidx_Google_ColumnBaseColumn';
  ...
  public function setBaseColumn(displetretsidx_Google_ColumnBaseColumn $baseColumn) {
...
class displetretsidx_Google_ColumnBaseColumn extends displetretsidx_Google_Model {
  public $tableIndex;
  public $columnId;
...
class displetretsidx_Google_ColumnList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Column';
  ...
  public function setItems(/* array(displetretsidx_Google_Column) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Column', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_Geometry extends displetretsidx_Google_Model {
  public $geometry;
  public $type;
  public $geometries;
  ...
  public function setGeometries(/* array(displetretsidx_Google_object) */ $geometries) {
    $this->assertIsArray($geometries, 'displetretsidx_Google_object', __METHOD__);
...
class displetretsidx_Google_Line extends displetretsidx_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
  ...
  public function setCoordinates(/* array(displetretsidx_Google_double) */ $coordinates) {
    $this->assertIsArray($coordinates, 'displetretsidx_Google_double', __METHOD__);
...
class displetretsidx_Google_LineStyle extends displetretsidx_Google_Model {
  public $strokeWeight;
  protected $__strokeWeightStylerType = 'displetretsidx_Google_StyleFunction';
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  public $strokeColor;
  public $strokeOpacity;
  protected $__strokeColorStylerType = 'displetretsidx_Google_StyleFunction';
  ...
  public function setStrokeWeightStyler(displetretsidx_Google_StyleFunction $strokeWeightStyler) {
  ...
  public function setStrokeColorStyler(displetretsidx_Google_StyleFunction $strokeColorStyler) {
...
class displetretsidx_Google_Point extends displetretsidx_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class displetretsidx_Google_PointStyle extends displetretsidx_Google_Model {
  protected $__iconStylerType = 'displetretsidx_Google_StyleFunction';
  protected $__iconStylerDataType = '';
  public $iconStyler;
  public $iconName;
  public function setIconStyler(displetretsidx_Google_StyleFunction $iconStyler) {
...
class displetretsidx_Google_Polygon extends displetretsidx_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class displetretsidx_Google_PolygonStyle extends displetretsidx_Google_Model {
  protected $__strokeColorStylerType = 'displetretsidx_Google_StyleFunction';
  protected $__strokeColorStylerDataType = '';
  public $strokeColorStyler;
  public $strokeWeight;
  ...
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  protected $__fillColorStylerType = 'displetretsidx_Google_StyleFunction';
  ...
  public function setFillColorStyler(displetretsidx_Google_StyleFunction $fillColorStyler) {
...
class displetretsidx_Google_Sqlresponse extends displetretsidx_Google_Model {
  public $kind;
  public $rows;
  public $columns;
  public function setKind($kind) {
  ...
  public function setRows(/* array(displetretsidx_Google_object) */ $rows) {
    $this->assertIsArray($rows, 'displetretsidx_Google_object', __METHOD__);
    $this->rows = $rows;
  }
  public function getRows() {
    return $this->rows;
  }
  public function setColumns(/* array(displetretsidx_Google_string) */ $columns) {
    $this->assertIsArray($columns, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_StyleFunction extends displetretsidx_Google_Model {
  protected $__gradientType = 'displetretsidx_Google_StyleFunctionGradient';
  protected $__gradientDataType = '';
  public $gradient;
  public $columnName;
  protected $__bucketsType = 'displetretsidx_Google_Bucket';
  protected $__bucketsDataType = 'array';
  public $buckets;
  public $kind;
  public function setGradient(displetretsidx_Google_StyleFunctionGradient $gradient) {
  ...
  public function setBuckets(/* array(displetretsidx_Google_Bucket) */ $buckets) {
    $this->assertIsArray($buckets, 'displetretsidx_Google_Bucket', __METHOD__);
...
class displetretsidx_Google_StyleFunctionGradient extends displetretsidx_Google_Model {
  public $max;
  protected $__colorsType = 'displetretsidx_Google_StyleFunctionGradientColors';
  ...
  public function setColors(/* array(displetretsidx_Google_StyleFunctionGradientColors) */ $colors) {
    $this->assertIsArray($colors, 'displetretsidx_Google_StyleFunctionGradientColors', __METHOD__);
    $this->colors = $colors;
  }
...
class displetretsidx_Google_StyleFunctionGradientColors extends displetretsidx_Google_Model {
  public $color;
  public $opacity;
  public function setColor($color) {
    $this->color = $color;
...
class displetretsidx_Google_StyleSetting extends displetretsidx_Google_Model {
  protected $__markerOptionsType = 'displetretsidx_Google_PointStyle';
  protected $__markerOptionsDataType = '';
  public $markerOptions;
  public $kind;
  public $name;
  protected $__polygonOptionsType = 'displetretsidx_Google_PolygonStyle';
  protected $__polygonOptionsDataType = '';
  public $polygonOptions;
  public $isDefaultForTable;
  protected $__polylineOptionsType = 'displetretsidx_Google_LineStyle';
  protected $__polylineOptionsDataType = '';
  public $polylineOptions;
  public $tableId;
  public $styleId;
  public function setMarkerOptions(displetretsidx_Google_PointStyle $markerOptions) {
  ...
  public function setPolygonOptions(displetretsidx_Google_PolygonStyle $polygonOptions) {
  ...
  public function setPolylineOptions(displetretsidx_Google_LineStyle $polylineOptions) {
...
class displetretsidx_Google_StyleSettingList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_StyleSetting';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(displetretsidx_Google_StyleSetting) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_StyleSetting', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Table extends displetretsidx_Google_Model {
  ...
  public $sql;
  public $tableId;
  protected $__columnsType = 'displetretsidx_Google_Column';
  ...
  public function setBaseTableIds(/* array(displetretsidx_Google_string) */ $baseTableIds) {
    $this->assertIsArray($baseTableIds, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setColumns(/* array(displetretsidx_Google_Column) */ $columns) {
    $this->assertIsArray($columns, 'displetretsidx_Google_Column', __METHOD__);
    $this->columns = $columns;
  }
  public function getColumns() {
    return $this->columns;
...
class displetretsidx_Google_TableList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Table';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(displetretsidx_Google_Table) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Table', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Template extends displetretsidx_Google_Model {
  public $body;
  public $kind;
  public $name;
  ...
  public function setAutomaticColumnNames(/* array(displetretsidx_Google_string) */ $automaticColumnNames) {
    $this->assertIsArray($automaticColumnNames, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_TemplateList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Template';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(displetretsidx_Google_Template) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Template', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
