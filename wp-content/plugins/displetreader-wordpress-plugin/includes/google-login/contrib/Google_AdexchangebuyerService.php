 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adexchangebuyerService = new displetretsidx_Google_AdexchangebuyerService(...);
  ...
  class displetretsidx_Google_AccountsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_AccountsList
     */
    public function listAccounts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_AccountsList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param int $id The account id
     * @param displetretsidx_Google_Account $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Account
     */
    public function patch($id, displetretsidx_Google_Account $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Account
     */
    public function update($id, displetretsidx_Google_Account $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_CreativesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Creative
     */
    public function get($accountId, $buyerCreativeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Creative($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param displetretsidx_Google_Creative $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Creative
     */
    public function insert(displetretsidx_Google_Creative $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_CreativesList
     */
    public function listCreatives($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_CreativesList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_DirectDealsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_DirectDeal
     */
    public function get($id, $optParams = array()) {
      $params = array('id' => $id);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_DirectDeal($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_DirectDealsList
     */
    public function listDirectDeals($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_DirectDealsList($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Adexchangebuyer (v1.1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_AdexchangebuyerService extends displetretsidx_Google_Service {
  public $accounts;
  public $creatives;
  public $directDeals;
  /**
...
class displetretsidx_Google_Account extends displetretsidx_Google_Model {
  ...
  public function setBidderLocation(/* array(displetretsidx_Google_AccountBidderLocation) */ $bidderLocation) {
    $this->assertIsArray($bidderLocation, 'displetretsidx_Google_AccountBidderLocation', __METHOD__);
...
class displetretsidx_Google_AccountBidderLocation extends displetretsidx_Google_Model {
  public $maximumQps;
  public $region;
  public $url;
...
class displetretsidx_Google_AccountsList extends displetretsidx_Google_Model {
...
class displetretsidx_Google_Creative extends displetretsidx_Google_Model {
  public $HTMLSnippet;
  public $accountId;
  public $advertiserId;
...
class displetretsidx_Google_CreativesList extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Creative';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(displetretsidx_Google_Creative) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Creative', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_DirectDeal extends displetretsidx_Google_Model {
  public $accountId;
  public $advertiser;
  public $currencyCode;
  public $endTime;
...
class displetretsidx_Google_DirectDealsList extends displetretsidx_Google_Model {
  protected $__directDealsType = 'displetretsidx_Google_DirectDeal';
  protected $__directDealsDataType = 'array';
  public $directDeals;
  public $kind;
  public function setDirectDeals(/* array(displetretsidx_Google_DirectDeal) */ $directDeals) {
    $this->assertIsArray($directDeals, 'displetretsidx_Google_DirectDeal', __METHOD__);
