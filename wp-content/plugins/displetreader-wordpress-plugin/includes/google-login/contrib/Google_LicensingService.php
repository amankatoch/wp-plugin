 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $licensingService = new displetretsidx_Google_LicensingService(...);
   *   $licenseAssignments = $licensingService->licenseAssignments;
   *  </code>
   */
  class displetretsidx_Google_LicenseAssignmentsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_LicenseAssignmentInsert $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_LicenseAssignment
     */
    public function insert($productId, $skuId, displetretsidx_Google_LicenseAssignmentInsert $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_LicenseAssignment($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_LicenseAssignmentList
     */
    public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_LicenseAssignmentList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $userId email id or unique Id of the user
     * @param displetretsidx_Google_LicenseAssignment $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_LicenseAssignment
     */
    public function update($productId, $skuId, $userId, displetretsidx_Google_LicenseAssignment $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_LicenseAssignment
     */
    public function patch($productId, $skuId, $userId, displetretsidx_Google_LicenseAssignment $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
/**
 * Service definition for displetretsidx_Google_Licensing (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_LicensingService extends displetretsidx_Google_Service {
...
class displetretsidx_Google_LicenseAssignmentInsert extends displetretsidx_Google_Model {
  public $userId;
  public function setUserId($userId) {
    $this->userId = $userId;
  }
...
class displetretsidx_Google_LicenseAssignmentList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_LicenseAssignment';
  ...
  public function setItems(/* array(displetretsidx_Google_LicenseAssignment) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_LicenseAssignment', __METHOD__);
    $this->items = $items;
  }
