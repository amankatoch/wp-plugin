 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $tasksService = new displetretsidx_Google_TasksService(...);
  ...
  class displetretsidx_Google_TasksServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     */
    public function insert($tasklist, displetretsidx_Google_Task $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Task
     */
    public function update($tasklist, $task, displetretsidx_Google_Task $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Task
     */
    public function patch($tasklist, $task, displetretsidx_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_TasklistsServiceResource extends displetretsidx_Google_ServiceResource {


    /**
     * Creates a new task list and adds it to the authenticated user's task lists. (tasklists.insert)
     *
     * @param displetretsidx_Google_TaskList $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_TaskList
     */
    public function insert(displetretsidx_Google_TaskList $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_TaskList($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Token specifying the result page to return. Optional.
     * @opt_param string maxResults Maximum number of task lists returned on one page. Optional. The default is 100.
     * @return displetretsidx_Google_TaskLists
     */
    public function listTasklists($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_TaskLists($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_TaskList
     */
    public function update($tasklist, displetretsidx_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return displetretsidx_Google_TaskList
     */
    public function patch($tasklist, displetretsidx_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for displetretsidx_Google_Tasks (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_TasksService extends displetretsidx_Google_Service {
  public $tasks;
  public $tasklists;
  /**
...
class displetretsidx_Google_Task extends displetretsidx_Google_Model {
  ...
  public $updated;
  public $parent;
  protected $__linksType = 'displetretsidx_Google_TaskLinks';
  ...
  public function setLinks(/* array(displetretsidx_Google_TaskLinks) */ $links) {
    $this->assertIsArray($links, 'displetretsidx_Google_TaskLinks', __METHOD__);
    $this->links = $links;
  }
...
class displetretsidx_Google_TaskLinks extends displetretsidx_Google_Model {
  public $type;
  public $link;
  public $description;
...
class displetretsidx_Google_TaskList extends displetretsidx_Google_Model {
  public $kind;
  public $title;
  public $updated;
  public $etag;
...
class displetretsidx_Google_TaskLists extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_TaskList';
  ...
  public function setItems(/* array(displetretsidx_Google_TaskList) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_TaskList', __METHOD__);
    $this->items = $items;
  }
