 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $storageService = new displetretsidx_Google_StorageService(...);
   *   $objectAccessControls = $storageService->objectAccessControls;
   *  </code>
   */
  class displetretsidx_Google_ObjectAccessControlsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_ObjectAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_ObjectAccessControl
     */
    public function insert($bucket, $object, displetretsidx_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_ObjectAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $object Name of the object.
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_ObjectAccessControls
     */
    public function listObjectAccessControls($bucket, $object, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_ObjectAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_ObjectAccessControl
     */
    public function update($bucket, $object, $entity, displetretsidx_Google_ObjectAccessControl $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_ObjectAccessControl
     */
    public function patch($bucket, $object, $entity, displetretsidx_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_BucketAccessControlsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @param string $bucket Name of a bucket.
     * @param displetretsidx_Google_BucketAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_BucketAccessControl
     */
    public function insert($bucket, displetretsidx_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_BucketAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $bucket Name of a bucket.
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_BucketAccessControls
     */
    public function listBucketAccessControls($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_BucketAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_BucketAccessControl
     */
    public function update($bucket, $entity, displetretsidx_Google_BucketAccessControl $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_BucketAccessControl
     */
    public function patch($bucket, $entity, displetretsidx_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class displetretsidx_Google_ObjectsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_StorageObject $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return displetretsidx_Google_StorageObject
     */
    public function insert($bucket, displetretsidx_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_StorageObject($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Objects
     */
    public function listObjects($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Objects($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_StorageObject
     */
    public function update($bucket, $object, displetretsidx_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return displetretsidx_Google_StorageObject
     */
    public function patch($bucket, $object, displetretsidx_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class displetretsidx_Google_BucketsServiceResource extends displetretsidx_Google_ServiceResource {


    /**
     * Creates a new bucket. (buckets.insert)
     *
     * @param displetretsidx_Google_Bucket $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return displetretsidx_Google_Bucket
     */
    public function insert(displetretsidx_Google_Bucket $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Bucket($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken A previously-returned page token representing part of the larger set of results to view.
     * @opt_param string projection Set of properties to return. Defaults to no_acl.
     * @return displetretsidx_Google_Buckets
     */
    public function listBuckets($projectId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Buckets($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Bucket
     */
    public function update($bucket, displetretsidx_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return displetretsidx_Google_Bucket
     */
    public function patch($bucket, displetretsidx_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for displetretsidx_Google_Storage (v1beta1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_StorageService extends displetretsidx_Google_Service {
...
class displetretsidx_Google_Bucket extends displetretsidx_Google_Model {
  ...
  public function setAcl(/* array(displetretsidx_Google_BucketAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'displetretsidx_Google_BucketAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
  }
  public function setDefaultObjectAcl(/* array(displetretsidx_Google_ObjectAccessControl) */ $defaultObjectAcl) {
    $this->assertIsArray($defaultObjectAcl, 'displetretsidx_Google_ObjectAccessControl', __METHOD__);
  ...
  public function setOwner(displetretsidx_Google_BucketOwner $owner) {
    $this->owner = $owner;
  }
...
class displetretsidx_Google_BucketAccessControl extends displetretsidx_Google_Model {
  public $domain;
  public $bucket;
  public $kind;
  public $id;
...
class displetretsidx_Google_BucketAccessControls extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_BucketAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_BucketAccessControl) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_BucketAccessControl', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_BucketOwner extends displetretsidx_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
...
class displetretsidx_Google_BucketWebsite extends displetretsidx_Google_Model {
  public $notFoundPage;
...
class displetretsidx_Google_Buckets extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Bucket';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(displetretsidx_Google_Bucket) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Bucket', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_ObjectAccessControl extends displetretsidx_Google_Model {
  public $domain;
  public $object;
  public $bucket;
  public $kind;
...
class displetretsidx_Google_ObjectAccessControls extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_ObjectAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_ObjectAccessControl) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_ObjectAccessControl', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Objects extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_StorageObject';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $prefixes;
  ...
  public function setItems(/* array(displetretsidx_Google_StorageObject) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_StorageObject', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  ...
  public function setPrefixes(/* array(displetretsidx_Google_string) */ $prefixes) {
    $this->assertIsArray($prefixes, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_StorageObject extends displetretsidx_Google_Model {
  public $kind;
  public $name;
  protected $__mediaType = 'displetretsidx_Google_StorageObjectMedia';
  protected $__mediaDataType = '';
  public $media;
  public $bucket;
  public $contentEncoding;
  public $selfLink;
  protected $__ownerType = 'displetretsidx_Google_StorageObjectOwner';
  protected $__ownerDataType = '';
  public $owner;
  public $cacheControl;
  protected $__aclType = 'displetretsidx_Google_ObjectAccessControl';
  protected $__aclDataType = 'array';
  public $acl;
  public $id;
  ...
  public function setMedia(displetretsidx_Google_StorageObjectMedia $media) {
    $this->media = $media;
  }
  ...
  public function setOwner(displetretsidx_Google_StorageObjectOwner $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  ...
  public function setAcl(/* array(displetretsidx_Google_ObjectAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'displetretsidx_Google_ObjectAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
...
class displetretsidx_Google_StorageObjectMedia extends displetretsidx_Google_Model {
  public $contentType;
  public $timeCreated;
  public $algorithm;
  public $length;
...
class displetretsidx_Google_StorageObjectOwner extends displetretsidx_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
