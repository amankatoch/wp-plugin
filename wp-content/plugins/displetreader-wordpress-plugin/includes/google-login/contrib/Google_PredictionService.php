 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $predictionService = new displetretsidx_Google_PredictionService(...);
   *   $trainedmodels = $predictionService->trainedmodels;
   *  </code>
   */
  class displetretsidx_Google_TrainedmodelsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Input $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Output
     */
    public function predict($id, displetretsidx_Google_Input $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('predict', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Output($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param displetretsidx_Google_Training $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Training
     */
    public function insert(displetretsidx_Google_Training $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Training($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $id The unique name for the predictive model.
     * @param displetretsidx_Google_Update $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Training
     */
    public function update($id, displetretsidx_Google_Update $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_HostedmodelsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Output
     */
    public function predict($hostedModelName, displetretsidx_Google_Input $postBody, $optParams = array()) {
...
/**
 * Service definition for displetretsidx_Google_Prediction (v1.4).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_PredictionService extends displetretsidx_Google_Service {
...
class displetretsidx_Google_InputInput extends displetretsidx_Google_Model {
  public $csvInstance;
  public function setCsvInstance(/* array(displetretsidx_Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'displetretsidx_Google_object', __METHOD__);
...
class displetretsidx_Google_Output extends displetretsidx_Google_Model {
  public $kind;
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'displetretsidx_Google_OutputOutputMulti';
  ...
  public function setOutputMulti(/* array(displetretsidx_Google_OutputOutputMulti) */ $outputMulti) {
    $this->assertIsArray($outputMulti, 'displetretsidx_Google_OutputOutputMulti', __METHOD__);
...
class displetretsidx_Google_OutputOutputMulti extends displetretsidx_Google_Model {
  public $score;
  public $label;
...
class displetretsidx_Google_Training extends displetretsidx_Google_Model {
  public $kind;
  public $storageDataLocation;
  public $storagePMMLModelLocation;
  protected $__dataAnalysisType = 'displetretsidx_Google_TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'displetretsidx_Google_TrainingModelInfo';
  ...
  public function setDataAnalysis(displetretsidx_Google_TrainingDataAnalysis $dataAnalysis) {
  ...
  public function setModelInfo(displetretsidx_Google_TrainingModelInfo $modelInfo) {
  ...
  public function setUtility(/* array(displetretsidx_Google_double) */ $utility) {
    $this->assertIsArray($utility, 'displetretsidx_Google_double', __METHOD__);
...
class displetretsidx_Google_TrainingDataAnalysis extends displetretsidx_Google_Model {
  public $warnings;
  public function setWarnings(/* array(displetretsidx_Google_string) */ $warnings) {
    $this->assertIsArray($warnings, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_TrainingModelInfo extends displetretsidx_Google_Model {
...
class displetretsidx_Google_Update extends displetretsidx_Google_Model {
  public $csvInstance;
  public $label;
  public function setCsvInstance(/* array(displetretsidx_Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'displetretsidx_Google_object', __METHOD__);
