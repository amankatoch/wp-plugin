 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $plusService = new displetretsidx_Google_PlusMomentsService(...);
...
/**
 * Service definition for displetretsidx_Google_Plus (v1moments).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_PlusMomentsService extends displetretsidx_Google_Service {
  public $moments;
  /**
  ...
  public function __construct(displetretsidx_Google_Client $client) {
    ...
    $this->moments = new displetretsidx_Google_MomentsServiceResource($this, $this->serviceName, 'moments',
...
class displetretsidx_Google_Moment extends displetretsidx_Google_Model {
  ...
  public $target;
  protected $__verbType = 'displetretsidx_Google_MomentVerb';
  ...
  public function setVerb(displetretsidx_Google_MomentVerb $verb) {
    $this->verb = $verb;
  }
...
class displetretsidx_Google_MomentVerb extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
