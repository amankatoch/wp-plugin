 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $computeService = new displetretsidx_Google_ComputeService(...);
   *   $disks = $computeService->disks;
   *  </code>
   */
  class displetretsidx_Google_DisksServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Operation
     */
    public function delete($project, $zone, $disk, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Operation($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Disk
     */
    public function get($project, $zone, $disk, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Disk($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $project Name of the project scoping this request.
     * @param string $zone Name of the zone scoping this request.
     * @param displetretsidx_Google_Disk $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string sourceImage Optional. Source image to restore onto a disk.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, $zone, displetretsidx_Google_Disk $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_DiskList
     */
    public function listDisks($project, $zone, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_DiskList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_FirewallsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Firewall
     */
    public function get($project, $firewall, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Firewall($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param displetretsidx_Google_Firewall $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, displetretsidx_Google_Firewall $postBody, $optParams = array()) {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_FirewallList
     */
    public function listFirewalls($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_FirewallList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Operation
     */
    public function patch($project, $firewall, displetretsidx_Google_Firewall $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Operation
     */
    public function update($project, $firewall, displetretsidx_Google_Firewall $postBody, $optParams = array()) {
      $params = array('project' => $project, 'firewall' => $firewall, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_GlobalOperationsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_OperationList
     */
    public function listGlobalOperations($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_OperationList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_ImagesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_DeprecationStatus $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function deprecate($project, $image, displetretsidx_Google_DeprecationStatus $postBody, $optParams = array()) {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Image
     */
    public function get($project, $image, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Image($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param displetretsidx_Google_Image $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, displetretsidx_Google_Image $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_ImageList
     */
    public function listImages($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_ImageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_InstancesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_AccessConfig $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function addAccessConfig($project, $zone, $instance, $network_interface, displetretsidx_Google_AccessConfig $postBody, $optParams = array()) {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Instance
     */
    public function get($project, $zone, $instance, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Instance($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_SerialPortOutput
     */
    public function getSerialPortOutput($project, $zone, $instance, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_SerialPortOutput($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $project Name of the project scoping this request.
     * @param string $zone Name of the zone scoping this request.
     * @param displetretsidx_Google_Instance $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, $zone, displetretsidx_Google_Instance $postBody, $optParams = array()) {
      $params = array('project' => $project, 'zone' => $zone, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_InstanceList
     */
    public function listInstances($project, $zone, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_InstanceList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $zone Name of the zone scoping this request.
     * @param string $instance Name of the instance scoping this request.
     * @param displetretsidx_Google_Metadata $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function setMetadata($project, $zone, $instance, displetretsidx_Google_Metadata $postBody, $optParams = array()) {
     ...
     * @param string $zone Name of the zone scoping this request.
     * @param string $instance Name of the instance scoping this request.
     * @param displetretsidx_Google_Tags $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function setTags($project, $zone, $instance, displetretsidx_Google_Tags $postBody, $optParams = array()) {
      $params = array('project' => $project, 'zone' => $zone, 'instance' => $instance, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_KernelsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Kernel
     */
    public function get($project, $kernel, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Kernel($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_KernelList
     */
    public function listKernels($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_KernelList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_MachineTypesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_MachineType
     */
    public function get($project, $machineType, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_MachineType($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_MachineTypeList
     */
    public function listMachineTypes($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_MachineTypeList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_NetworksServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Network
     */
    public function get($project, $network, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Network($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param displetretsidx_Google_Network $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, displetretsidx_Google_Network $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_NetworkList
     */
    public function listNetworks($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_NetworkList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_ProjectsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Project
     */
    public function get($project, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Project($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Operation
     */
    public function setCommonInstanceMetadata($project, displetretsidx_Google_Metadata $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_SnapshotsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Snapshot
     */
    public function get($project, $snapshot, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Snapshot($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param displetretsidx_Google_Snapshot $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Operation
     */
    public function insert($project, displetretsidx_Google_Snapshot $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_SnapshotList
     */
    public function listSnapshots($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_SnapshotList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_ZoneOperationsServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_ZonesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Zone
     */
    public function get($project, $zone, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Zone($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @return displetretsidx_Google_ZoneList
     */
    public function listZones($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_ZoneList($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Compute (v1beta14).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_ComputeService extends displetretsidx_Google_Service {
  public $disks;
  public $firewalls;
...
class displetretsidx_Google_AttachedDisk extends displetretsidx_Google_Model {
  public $boot;
  public $deviceName;
  public $index;
  public $kind;
...
class displetretsidx_Google_DeprecationStatus extends displetretsidx_Google_Model {
  public $deleted;
  public $deprecated;
  public $obsolete;
  public $replacement;
...
class displetretsidx_Google_Disk extends displetretsidx_Google_Model {
...
class displetretsidx_Google_DiskList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Disk';
  ...
  public function setItems(/* array(displetretsidx_Google_Disk) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Disk', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_Firewall extends displetretsidx_Google_Model {
  protected $__allowedType = 'displetretsidx_Google_FirewallAllowed';
  ...
  public $sourceTags;
  public $targetTags;
  public function setAllowed(/* array(displetretsidx_Google_FirewallAllowed) */ $allowed) {
    $this->assertIsArray($allowed, 'displetretsidx_Google_FirewallAllowed', __METHOD__);
  ...
  public function setSourceRanges(/* array(displetretsidx_Google_string) */ $sourceRanges) {
    $this->assertIsArray($sourceRanges, 'displetretsidx_Google_string', __METHOD__);
    $this->sourceRanges = $sourceRanges;
  }
  public function getSourceRanges() {
    return $this->sourceRanges;
  }
  public function setSourceTags(/* array(displetretsidx_Google_string) */ $sourceTags) {
    $this->assertIsArray($sourceTags, 'displetretsidx_Google_string', __METHOD__);
    $this->sourceTags = $sourceTags;
  }
  public function getSourceTags() {
    return $this->sourceTags;
  }
  public function setTargetTags(/* array(displetretsidx_Google_string) */ $targetTags) {
    $this->assertIsArray($targetTags, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_FirewallAllowed extends displetretsidx_Google_Model {
  public $IPProtocol;
  public $ports;
  ...
  public function setPorts(/* array(displetretsidx_Google_string) */ $ports) {
    $this->assertIsArray($ports, 'displetretsidx_Google_string', __METHOD__);
    $this->ports = $ports;
  }
...
class displetretsidx_Google_FirewallList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Firewall';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Firewall) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Firewall', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Image extends displetretsidx_Google_Model {
  public $creationTimestamp;
  protected $__deprecatedType = 'displetretsidx_Google_DeprecationStatus';
  ...
  protected $__rawDiskType = 'displetretsidx_Google_ImageRawDisk';
  ...
  public function setDeprecated(displetretsidx_Google_DeprecationStatus $deprecated) {
    $this->deprecated = $deprecated;
  }
  public function getDeprecated() {
    return $this->deprecated;
  ...
  public function setRawDisk(displetretsidx_Google_ImageRawDisk $rawDisk) {
...
class displetretsidx_Google_ImageList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Image';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Image) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Image', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_ImageRawDisk extends displetretsidx_Google_Model {
...
class displetretsidx_Google_Instance extends displetretsidx_Google_Model {
  public $canIpForward;
  public $creationTimestamp;
  public $description;
  protected $__disksType = 'displetretsidx_Google_AttachedDisk';
  ...
  public $kind;
  public $machineType;
  protected $__metadataType = 'displetretsidx_Google_Metadata';
  protected $__metadataDataType = '';
  public $metadata;
  public $name;
  protected $__networkInterfacesType = 'displetretsidx_Google_NetworkInterface';
  protected $__networkInterfacesDataType = 'array';
  public $networkInterfaces;
  public $selfLink;
  protected $__serviceAccountsType = 'displetretsidx_Google_ServiceAccount';
  protected $__serviceAccountsDataType = 'array';
  public $serviceAccounts;
  public $status;
  public $statusMessage;
  protected $__tagsType = 'displetretsidx_Google_Tags';
  ...
  public function setDisks(/* array(displetretsidx_Google_AttachedDisk) */ $disks) {
    $this->assertIsArray($disks, 'displetretsidx_Google_AttachedDisk', __METHOD__);
    $this->disks = $disks;
  }
  ...
  public function setMetadata(displetretsidx_Google_Metadata $metadata) {
  ...
  public function setNetworkInterfaces(/* array(displetretsidx_Google_NetworkInterface) */ $networkInterfaces) {
    $this->assertIsArray($networkInterfaces, 'displetretsidx_Google_NetworkInterface', __METHOD__);
  ...
  public function setServiceAccounts(/* array(displetretsidx_Google_ServiceAccount) */ $serviceAccounts) {
    $this->assertIsArray($serviceAccounts, 'displetretsidx_Google_ServiceAccount', __METHOD__);
  ...
  public function setTags(displetretsidx_Google_Tags $tags) {
    $this->tags = $tags;
  }
...
class displetretsidx_Google_InstanceList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Instance';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Instance) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Instance', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Kernel extends displetretsidx_Google_Model {
  public $creationTimestamp;
  protected $__deprecatedType = 'displetretsidx_Google_DeprecationStatus';
  protected $__deprecatedDataType = '';
  public $deprecated;
...
class displetretsidx_Google_KernelList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Kernel';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Kernel) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Kernel', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_MachineType extends displetretsidx_Google_Model {
  ...
  public $deprecated;
  public $description;
  protected $__ephemeralDisksType = 'displetretsidx_Google_MachineTypeEphemeralDisks';
  ...
  public $name;
  public $selfLink;
  public function setAvailableZone(/* array(displetretsidx_Google_string) */ $availableZone) {
    $this->assertIsArray($availableZone, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setEphemeralDisks(/* array(displetretsidx_Google_MachineTypeEphemeralDisks) */ $ephemeralDisks) {
    $this->assertIsArray($ephemeralDisks, 'displetretsidx_Google_MachineTypeEphemeralDisks', __METHOD__);
...
class displetretsidx_Google_MachineTypeEphemeralDisks extends displetretsidx_Google_Model {
  public $diskGb;
...
class displetretsidx_Google_MachineTypeList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_MachineType';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_MachineType) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_MachineType', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Metadata extends displetretsidx_Google_Model {
  public $fingerprint;
  protected $__itemsType = 'displetretsidx_Google_MetadataItems';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(displetretsidx_Google_MetadataItems) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_MetadataItems', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_MetadataItems extends displetretsidx_Google_Model {
  public $key;
  public $value;
...
class displetretsidx_Google_Network extends displetretsidx_Google_Model {
  public $IPv4Range;
  public $creationTimestamp;
  public $description;
  public $gatewayIPv4;
...
class displetretsidx_Google_NetworkInterface extends displetretsidx_Google_Model {
  protected $__accessConfigsType = 'displetretsidx_Google_AccessConfig';
  protected $__accessConfigsDataType = 'array';
  public $accessConfigs;
  public $name;
  public $network;
  public $networkIP;
  public function setAccessConfigs(/* array(displetretsidx_Google_AccessConfig) */ $accessConfigs) {
    $this->assertIsArray($accessConfigs, 'displetretsidx_Google_AccessConfig', __METHOD__);
...
class displetretsidx_Google_NetworkList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Network';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Network) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Network', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Operation extends displetretsidx_Google_Model {
  public $clientOperationId;
  public $creationTimestamp;
  public $endTime;
  protected $__errorType = 'displetretsidx_Google_OperationError';
  ...
  public $targetLink;
  public $user;
  protected $__warningsType = 'displetretsidx_Google_OperationWarnings';
  ...
  public function setError(displetretsidx_Google_OperationError $error) {
    $this->error = $error;
  }
  ...
  public function setWarnings(/* array(displetretsidx_Google_OperationWarnings) */ $warnings) {
    $this->assertIsArray($warnings, 'displetretsidx_Google_OperationWarnings', __METHOD__);
...
class displetretsidx_Google_OperationError extends displetretsidx_Google_Model {
  protected $__errorsType = 'displetretsidx_Google_OperationErrorErrors';
  protected $__errorsDataType = 'array';
  public $errors;
  public function setErrors(/* array(displetretsidx_Google_OperationErrorErrors) */ $errors) {
    $this->assertIsArray($errors, 'displetretsidx_Google_OperationErrorErrors', __METHOD__);
    $this->errors = $errors;
  }
...
class displetretsidx_Google_OperationErrorErrors extends displetretsidx_Google_Model {
  public $code;
  public $location;
  public $message;
...
class displetretsidx_Google_OperationList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Operation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Operation) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Operation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_OperationWarnings extends displetretsidx_Google_Model {
  public $code;
  protected $__dataType = 'displetretsidx_Google_OperationWarningsData';
  ...
  public function setData(/* array(displetretsidx_Google_OperationWarningsData) */ $data) {
    $this->assertIsArray($data, 'displetretsidx_Google_OperationWarningsData', __METHOD__);
    $this->data = $data;
  }
...
class displetretsidx_Google_OperationWarningsData extends displetretsidx_Google_Model {
  public $key;
  public $value;
  public function setKey($key) {
    $this->key = $key;
...
class displetretsidx_Google_Project extends displetretsidx_Google_Model {
  protected $__commonInstanceMetadataType = 'displetretsidx_Google_Metadata';
  ...
  public $kind;
  public $name;
  protected $__quotasType = 'displetretsidx_Google_Quota';
  protected $__quotasDataType = 'array';
  public $quotas;
  public $selfLink;
  public function setCommonInstanceMetadata(displetretsidx_Google_Metadata $commonInstanceMetadata) {
  ...
  public function setExternalIpAddresses(/* array(displetretsidx_Google_string) */ $externalIpAddresses) {
    $this->assertIsArray($externalIpAddresses, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setQuotas(/* array(displetretsidx_Google_Quota) */ $quotas) {
    $this->assertIsArray($quotas, 'displetretsidx_Google_Quota', __METHOD__);
    $this->quotas = $quotas;
  }
...
class displetretsidx_Google_Quota extends displetretsidx_Google_Model {
  public $limit;
  public $metric;
  public $usage;
...
class displetretsidx_Google_SerialPortOutput extends displetretsidx_Google_Model {
  public $contents;
  public $kind;
  public $selfLink;
...
class displetretsidx_Google_ServiceAccount extends displetretsidx_Google_Model {
  public $email;
  public $scopes;
  ...
  public function setScopes(/* array(displetretsidx_Google_string) */ $scopes) {
    $this->assertIsArray($scopes, 'displetretsidx_Google_string', __METHOD__);
    $this->scopes = $scopes;
  }
...
class displetretsidx_Google_Snapshot extends displetretsidx_Google_Model {
  public $creationTimestamp;
  public $description;
  public $diskSizeGb;
  public $id;
...
class displetretsidx_Google_SnapshotList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Snapshot';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Snapshot) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Snapshot', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Tags extends displetretsidx_Google_Model {
  public $fingerprint;
  public $items;
  public function setFingerprint($fingerprint) {
    $this->fingerprint = $fingerprint;
  ...
  public function setItems(/* array(displetretsidx_Google_string) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_string', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Zone extends displetretsidx_Google_Model {
  ...
  public $id;
  public $kind;
  protected $__maintenanceWindowsType = 'displetretsidx_Google_ZoneMaintenanceWindows';
  ...
  public $selfLink;
  public $status;
  public function setAvailableMachineType(/* array(displetretsidx_Google_string) */ $availableMachineType) {
    $this->assertIsArray($availableMachineType, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setMaintenanceWindows(/* array(displetretsidx_Google_ZoneMaintenanceWindows) */ $maintenanceWindows) {
    $this->assertIsArray($maintenanceWindows, 'displetretsidx_Google_ZoneMaintenanceWindows', __METHOD__);
...
class displetretsidx_Google_ZoneList extends displetretsidx_Google_Model {
  public $id;
  protected $__itemsType = 'displetretsidx_Google_Zone';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(displetretsidx_Google_Zone) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Zone', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_ZoneMaintenanceWindows extends displetretsidx_Google_Model {
  public $beginTime;
  public $description;
  public $endTime;
  public $name;
