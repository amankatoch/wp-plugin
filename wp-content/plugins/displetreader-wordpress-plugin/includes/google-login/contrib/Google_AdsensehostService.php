 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new displetretsidx_Google_AdSenseHostService(...);
  ...
  class displetretsidx_Google_AccountsAdclientsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_AdClient
     */
    public function get($accountId, $adClientId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_AdClient($data);
      } else {
        return $data;
      }
    }
  ...
  class displetretsidx_Google_AccountsAdunitsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_AdCode
     */
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_AdCode($data);
      } else {
        return $data;
      }
    }
     ...
     * @param displetretsidx_Google_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_AdUnit
     */
    public function insert($accountId, $adClientId, displetretsidx_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_AdUnit
     */
    public function patch($accountId, $adClientId, $adUnitId, displetretsidx_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_AdUnit
     */
    public function update($accountId, $adClientId, displetretsidx_Google_AdUnit $postBody, $optParams = array()) {
      $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_AssociationsessionsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_AssociationSession
     */
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_AssociationSession($data);
      } else {
        return $data;
      }
    }
  ...
  class displetretsidx_Google_CustomchannelsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_CustomChannel
     */
    public function insert($adClientId, displetretsidx_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_CustomChannel
     */
    public function patch($adClientId, $customChannelId, displetretsidx_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_CustomChannel
     */
    public function update($adClientId, displetretsidx_Google_CustomChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
  ...
  class displetretsidx_Google_UrlchannelsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_UrlChannel
     */
    public function delete($adClientId, $urlChannelId, $optParams = array()) {
      ...
      $data = $this->__call('delete', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_UrlChannel($data);
      } else {
        return $data;
      }
    }
     ...
     * @param displetretsidx_Google_UrlChannel $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_UrlChannel
     */
    public function insert($adClientId, displetretsidx_Google_UrlChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for displetretsidx_Google_AdSenseHost (v4.1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_AdSenseHostService extends displetretsidx_Google_Service {
  public $accounts;
...
class displetretsidx_Google_AdCode extends displetretsidx_Google_Model {
  public $adCode;
  public $kind;
...
class displetretsidx_Google_AssociationSession extends displetretsidx_Google_Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
...
class displetretsidx_Google_Report extends displetretsidx_Google_Model {
  public $averages;
  protected $__headersType = 'displetretsidx_Google_ReportHeaders';
  ...
  public function setHeaders(/* array(displetretsidx_Google_ReportHeaders) */ $headers) {
    $this->assertIsArray($headers, 'displetretsidx_Google_ReportHeaders', __METHOD__);
...
class displetretsidx_Google_ReportHeaders extends displetretsidx_Google_Model {
  public $currency;
  public $name;
  public $type;
