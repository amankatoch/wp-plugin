 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $booksService = new displetretsidx_Google_BooksService(...);
   *   $layers = $booksService->layers;
   *  </code>
   */
  class displetretsidx_Google_LayersServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Layersummaries
     */
    public function listLayers($volumeId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Layersummaries($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param string contentVersion The content version for the requested volume.
     * @return displetretsidx_Google_Layersummary
     */
    public function get($volumeId, $summaryId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Layersummary($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_LayersAnnotationDataServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Annotationsdata
     */
    public function listLayersAnnotationData($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Annotationsdata($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param int w The requested pixel width for any images. If width is provided height must also be provided.
     * @return displetretsidx_Google_Annotationdata
     */
    public function get($volumeId, $layerId, $annotationDataId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Annotationdata($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_LayersVolumeAnnotationsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Volumeannotations
     */
    public function listLayersVolumeAnnotations($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Volumeannotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
     * @opt_param string source String to identify the originator of this request.
     * @return displetretsidx_Google_Volumeannotation
     */
    public function get($volumeId, $layerId, $annotationId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Volumeannotation($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_BookshelvesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return displetretsidx_Google_Bookshelves
     */
    public function listBookshelves($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Bookshelves($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return displetretsidx_Google_Bookshelf
     */
    public function get($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Bookshelf($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_BookshelvesVolumesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Volumes
     */
    public function listBookshelvesVolumes($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Volumes($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_MyconfigServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @opt_param string source String to identify the originator of this request.
     * @return displetretsidx_Google_DownloadAccesses
     */
    public function releaseDownloadAccess($volumeIds, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_DownloadAccesses($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string locale ISO-639-1, ISO-3166-1 codes for message localization, i.e. en_US.
     * @return displetretsidx_Google_RequestAccess
     */
    public function requestAccess($source, $volumeId, $nonce, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_RequestAccess($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_VolumesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_Volume
     */
    public function get($volumeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Volume($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_VolumesAssociatedServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_MylibraryServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_MylibraryBookshelvesServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_MylibraryBookshelvesVolumesServiceResource extends displetretsidx_Google_ServiceResource {
   ...
   *  </code>
   */
  class displetretsidx_Google_MylibraryReadingpositionsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_ReadingPosition
     */
    public function get($volumeId, $optParams = array()) {
      $params = array('volumeId' => $volumeId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_ReadingPosition($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_MylibraryAnnotationsServiceResource extends displetretsidx_Google_ServiceResource {


    /**
     * Inserts a new annotation. (annotations.insert)
     *
     * @param displetretsidx_Google_Annotation $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @return displetretsidx_Google_Annotation
     */
    public function insert(displetretsidx_Google_Annotation $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Annotation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Annotations
     */
    public function listMylibraryAnnotations($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Annotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Annotation
     */
    public function update($annotationId, displetretsidx_Google_Annotation $postBody, $optParams = array()) {
...
/**
 * Service definition for displetretsidx_Google_Books (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_BooksService extends displetretsidx_Google_Service {
  public $layers;
...
class displetretsidx_Google_Annotation extends displetretsidx_Google_Model {
  ...
  public function setCurrentVersionRanges(displetretsidx_Google_AnnotationCurrentVersionRanges $currentVersionRanges) {
  ...
  public function setClientVersionRanges(displetretsidx_Google_AnnotationClientVersionRanges $clientVersionRanges) {
  ...
  public function setPageIds(/* array(displetretsidx_Google_string) */ $pageIds) {
    $this->assertIsArray($pageIds, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_AnnotationClientVersionRanges extends displetretsidx_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'displetretsidx_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
  protected $__cfiRangeType = 'displetretsidx_Google_BooksAnnotationsRange';
  protected $__cfiRangeDataType = '';
  public $cfiRange;
  protected $__gbImageRangeType = 'displetretsidx_Google_BooksAnnotationsRange';
  ...
  public function setGbTextRange(displetretsidx_Google_BooksAnnotationsRange $gbTextRange) {
    $this->gbTextRange = $gbTextRange;
  }
  public function getGbTextRange() {
    return $this->gbTextRange;
  }
  public function setCfiRange(displetretsidx_Google_BooksAnnotationsRange $cfiRange) {
    $this->cfiRange = $cfiRange;
  }
  public function getCfiRange() {
    return $this->cfiRange;
  }
  public function setGbImageRange(displetretsidx_Google_BooksAnnotationsRange $gbImageRange) {
...
class displetretsidx_Google_AnnotationCurrentVersionRanges extends displetretsidx_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'displetretsidx_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class displetretsidx_Google_Annotationdata extends displetretsidx_Google_Model {
  ...
  public $encoded_data;
  public $layerId;
  protected $__dataType = 'displetretsidx_Google_BooksLayerGeoData';
  ...
  public function setData(displetretsidx_Google_BooksLayerGeoData $data) {
    $this->data = $data;
  }
  public function getData() {
    return $this->data;
...
class displetretsidx_Google_Annotations extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Annotation';
  ...
  public function setItems(/* array(displetretsidx_Google_Annotation) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Annotation', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_Annotationsdata extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Annotationdata';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(displetretsidx_Google_Annotationdata) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Annotationdata', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_BooksAnnotationsRange extends displetretsidx_Google_Model {
...
class displetretsidx_Google_BooksLayerGeoData extends displetretsidx_Google_Model {
  protected $__geoType = 'displetretsidx_Google_BooksLayerGeoDataGeo';
  protected $__geoDataType = '';
  public $geo;
  protected $__commonType = 'displetretsidx_Google_BooksLayerGeoDataCommon';
  protected $__commonDataType = '';
  public $common;
  public function setGeo(displetretsidx_Google_BooksLayerGeoDataGeo $geo) {
    $this->geo = $geo;
  }
  public function getGeo() {
    return $this->geo;
  }
  public function setCommon(displetretsidx_Google_BooksLayerGeoDataCommon $common) {
    $this->common = $common;
  }
...
class displetretsidx_Google_BooksLayerGeoDataCommon extends displetretsidx_Google_Model {
  public $lang;
...
class displetretsidx_Google_BooksLayerGeoDataGeo extends displetretsidx_Google_Model {
  public $countryCode;
  public $title;
  public $zoom;
  public $longitude;
  public $mapType;
  public $latitude;
  protected $__boundaryType = 'displetretsidx_Google_BooksLayerGeoDataGeoBoundary';
  protected $__boundaryDataType = 'array';
  public $boundary;
  protected $__viewportType = 'displetretsidx_Google_BooksLayerGeoDataGeoViewport';
  ...
  public function setBoundary(/* array(displetretsidx_Google_BooksLayerGeoDataGeoBoundary) */ $boundary) {
    $this->assertIsArray($boundary, 'displetretsidx_Google_BooksLayerGeoDataGeoBoundary', __METHOD__);
    $this->boundary = $boundary;
  }
  public function getBoundary() {
    return $this->boundary;
  }
  public function setViewport(displetretsidx_Google_BooksLayerGeoDataGeoViewport $viewport) {
...
class displetretsidx_Google_BooksLayerGeoDataGeoBoundary extends displetretsidx_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class displetretsidx_Google_BooksLayerGeoDataGeoViewport extends displetretsidx_Google_Model {
  protected $__loType = 'displetretsidx_Google_BooksLayerGeoDataGeoViewportLo';
  protected $__loDataType = '';
  public $lo;
  protected $__hiType = 'displetretsidx_Google_BooksLayerGeoDataGeoViewportHi';
  protected $__hiDataType = '';
  public $hi;
  public function setLo(displetretsidx_Google_BooksLayerGeoDataGeoViewportLo $lo) {
    $this->lo = $lo;
  }
  public function getLo() {
    return $this->lo;
  }
  public function setHi(displetretsidx_Google_BooksLayerGeoDataGeoViewportHi $hi) {
    $this->hi = $hi;
  }
...
class displetretsidx_Google_BooksLayerGeoDataGeoViewportHi extends displetretsidx_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class displetretsidx_Google_BooksLayerGeoDataGeoViewportLo extends displetretsidx_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class displetretsidx_Google_Bookshelf extends displetretsidx_Google_Model {
  public $kind;
  public $description;
  public $created;
  public $volumeCount;
...
class displetretsidx_Google_Bookshelves extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Bookshelf';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Bookshelf) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Bookshelf', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_ConcurrentAccessRestriction extends displetretsidx_Google_Model {
  public $nonce;
  public $kind;
  public $restricted;
  public $volumeId;
...
class displetretsidx_Google_DownloadAccessRestriction extends displetretsidx_Google_Model {
  public $nonce;
  public $kind;
  public $justAcquired;
...
class displetretsidx_Google_DownloadAccesses extends displetretsidx_Google_Model {
  protected $__downloadAccessListType = 'displetretsidx_Google_DownloadAccessRestriction';
  protected $__downloadAccessListDataType = 'array';
  public $downloadAccessList;
  public $kind;
  public function setDownloadAccessList(/* array(displetretsidx_Google_DownloadAccessRestriction) */ $downloadAccessList) {
    $this->assertIsArray($downloadAccessList, 'displetretsidx_Google_DownloadAccessRestriction', __METHOD__);
...
class displetretsidx_Google_Layersummaries extends displetretsidx_Google_Model {
  public $totalItems;
  protected $__itemsType = 'displetretsidx_Google_Layersummary';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(displetretsidx_Google_Layersummary) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Layersummary', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Layersummary extends displetretsidx_Google_Model {
  public $kind;
  ...
  public function setAnnotationTypes(/* array(displetretsidx_Google_string) */ $annotationTypes) {
    $this->assertIsArray($annotationTypes, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_ReadingPosition extends displetretsidx_Google_Model {
  public $kind;
...
class displetretsidx_Google_RequestAccess extends displetretsidx_Google_Model {
  protected $__downloadAccessType = 'displetretsidx_Google_DownloadAccessRestriction';
  protected $__downloadAccessDataType = '';
  public $downloadAccess;
  public $kind;
  protected $__concurrentAccessType = 'displetretsidx_Google_ConcurrentAccessRestriction';
  protected $__concurrentAccessDataType = '';
  public $concurrentAccess;
  public function setDownloadAccess(displetretsidx_Google_DownloadAccessRestriction $downloadAccess) {
  ...
  public function setConcurrentAccess(displetretsidx_Google_ConcurrentAccessRestriction $concurrentAccess) {
...
class displetretsidx_Google_Review extends displetretsidx_Google_Model {
  public $rating;
  public $kind;
  protected $__authorType = 'displetretsidx_Google_ReviewAuthor';
  protected $__authorDataType = '';
  public $author;
  public $title;
  public $volumeId;
  public $content;
  protected $__sourceType = 'displetretsidx_Google_ReviewSource';
  ...
  public function setAuthor(displetretsidx_Google_ReviewAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setSource(displetretsidx_Google_ReviewSource $source) {
    $this->source = $source;
  }
  public function getSource() {
    return $this->source;
...
class displetretsidx_Google_ReviewAuthor extends displetretsidx_Google_Model {
  public $displayName;
...
class displetretsidx_Google_ReviewSource extends displetretsidx_Google_Model {
...
class displetretsidx_Google_Volume extends displetretsidx_Google_Model {
  public $kind;
  protected $__accessInfoType = 'displetretsidx_Google_VolumeAccessInfo';
  protected $__accessInfoDataType = '';
  public $accessInfo;
  protected $__searchInfoType = 'displetretsidx_Google_VolumeSearchInfo';
  protected $__searchInfoDataType = '';
  public $searchInfo;
  protected $__saleInfoType = 'displetretsidx_Google_VolumeSaleInfo';
  protected $__saleInfoDataType = '';
  public $saleInfo;
  public $etag;
  protected $__userInfoType = 'displetretsidx_Google_VolumeUserInfo';
  protected $__userInfoDataType = '';
  public $userInfo;
  protected $__volumeInfoType = 'displetretsidx_Google_VolumeVolumeInfo';
  ...
  public function setAccessInfo(displetretsidx_Google_VolumeAccessInfo $accessInfo) {
    $this->accessInfo = $accessInfo;
  }
  public function getAccessInfo() {
    return $this->accessInfo;
  }
  public function setSearchInfo(displetretsidx_Google_VolumeSearchInfo $searchInfo) {
    $this->searchInfo = $searchInfo;
  }
  public function getSearchInfo() {
    return $this->searchInfo;
  }
  public function setSaleInfo(displetretsidx_Google_VolumeSaleInfo $saleInfo) {
  ...
  public function setUserInfo(displetretsidx_Google_VolumeUserInfo $userInfo) {
    $this->userInfo = $userInfo;
  }
  public function getUserInfo() {
    return $this->userInfo;
  }
  public function setVolumeInfo(displetretsidx_Google_VolumeVolumeInfo $volumeInfo) {
...
class displetretsidx_Google_VolumeAccessInfo extends displetretsidx_Google_Model {
  ...
  protected $__pdfType = 'displetretsidx_Google_VolumeAccessInfoPdf';
  protected $__pdfDataType = '';
  public $pdf;
  public $viewability;
  protected $__epubType = 'displetretsidx_Google_VolumeAccessInfoEpub';
  ...
  public function setPdf(displetretsidx_Google_VolumeAccessInfoPdf $pdf) {
    $this->pdf = $pdf;
  }
  ...
  public function setEpub(displetretsidx_Google_VolumeAccessInfoEpub $epub) {
    $this->epub = $epub;
  }
...
class displetretsidx_Google_VolumeAccessInfoEpub extends displetretsidx_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
...
class displetretsidx_Google_VolumeAccessInfoPdf extends displetretsidx_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
  public function setIsAvailable($isAvailable) {
...
class displetretsidx_Google_VolumeSaleInfo extends displetretsidx_Google_Model {
  public $country;
  protected $__retailPriceType = 'displetretsidx_Google_VolumeSaleInfoRetailPrice';
  ...
  public $buyLink;
  public $onSaleDate;
  protected $__listPriceType = 'displetretsidx_Google_VolumeSaleInfoListPrice';
  ...
  public function setRetailPrice(displetretsidx_Google_VolumeSaleInfoRetailPrice $retailPrice) {
  ...
  public function setListPrice(displetretsidx_Google_VolumeSaleInfoListPrice $listPrice) {
...
class displetretsidx_Google_VolumeSaleInfoListPrice extends displetretsidx_Google_Model {
  public $amount;
  public $currencyCode;
...
class displetretsidx_Google_VolumeSaleInfoRetailPrice extends displetretsidx_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class displetretsidx_Google_VolumeSearchInfo extends displetretsidx_Google_Model {
  public $textSnippet;
...
class displetretsidx_Google_VolumeUserInfo extends displetretsidx_Google_Model {
  public $isInMyBooks;
  public $updated;
  protected $__reviewType = 'displetretsidx_Google_Review';
  protected $__reviewDataType = '';
  public $review;
  public $isPurchased;
  protected $__readingPositionType = 'displetretsidx_Google_ReadingPosition';
  ...
  public function setReview(displetretsidx_Google_Review $review) {
    $this->review = $review;
  }
  ...
  public function setReadingPosition(displetretsidx_Google_ReadingPosition $readingPosition) {
...
class displetretsidx_Google_VolumeVolumeInfo extends displetretsidx_Google_Model {
  public $publisher;
  public $subtitle;
  public $description;
  public $language;
  public $pageCount;
  protected $__imageLinksType = 'displetretsidx_Google_VolumeVolumeInfoImageLinks';
  ...
  public $ratingsCount;
  public $mainCategory;
  protected $__dimensionsType = 'displetretsidx_Google_VolumeVolumeInfoDimensions';
  protected $__dimensionsDataType = '';
  public $dimensions;
  public $contentVersion;
  protected $__industryIdentifiersType = 'displetretsidx_Google_VolumeVolumeInfoIndustryIdentifiers';
  ...
  public function setImageLinks(displetretsidx_Google_VolumeVolumeInfoImageLinks $imageLinks) {
  ...
  public function setDimensions(displetretsidx_Google_VolumeVolumeInfoDimensions $dimensions) {
  ...
  public function setIndustryIdentifiers(/* array(displetretsidx_Google_VolumeVolumeInfoIndustryIdentifiers) */ $industryIdentifiers) {
    $this->assertIsArray($industryIdentifiers, 'displetretsidx_Google_VolumeVolumeInfoIndustryIdentifiers', __METHOD__);
    $this->industryIdentifiers = $industryIdentifiers;
  }
  public function getIndustryIdentifiers() {
    return $this->industryIdentifiers;
  }
  public function setAuthors(/* array(displetretsidx_Google_string) */ $authors) {
    $this->assertIsArray($authors, 'displetretsidx_Google_string', __METHOD__);
  ...
  public function setCategories(/* array(displetretsidx_Google_string) */ $categories) {
    $this->assertIsArray($categories, 'displetretsidx_Google_string', __METHOD__);
...
class displetretsidx_Google_VolumeVolumeInfoDimensions extends displetretsidx_Google_Model {
  public $width;
  public $thickness;
  public $height;
...
class displetretsidx_Google_VolumeVolumeInfoImageLinks extends displetretsidx_Google_Model {
  public $medium;
...
class displetretsidx_Google_VolumeVolumeInfoIndustryIdentifiers extends displetretsidx_Google_Model {
  public $identifier;
  public $type;
...
class displetretsidx_Google_Volumeannotation extends displetretsidx_Google_Model {
  public $annotationType;
  public $kind;
  public $updated;
  public $deleted;
  protected $__contentRangesType = 'displetretsidx_Google_VolumeannotationContentRanges';
  ...
  public function setContentRanges(displetretsidx_Google_VolumeannotationContentRanges $contentRanges) {
...
class displetretsidx_Google_VolumeannotationContentRanges extends displetretsidx_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'displetretsidx_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class displetretsidx_Google_Volumeannotations extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Volumeannotation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(displetretsidx_Google_Volumeannotation) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Volumeannotation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Volumes extends displetretsidx_Google_Model {
  public $totalItems;
  protected $__itemsType = 'displetretsidx_Google_Volume';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(displetretsidx_Google_Volume) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Volume', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
