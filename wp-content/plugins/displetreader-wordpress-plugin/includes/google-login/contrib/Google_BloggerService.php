 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $bloggerService = new displetretsidx_Google_BloggerService(...);
   *   $blogs = $bloggerService->blogs;
   *  </code>
   */
  class displetretsidx_Google_BlogsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_BlogList
     */
    public function listByUser($userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_BlogList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Blog
     */
    public function getByUrl($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_Blog($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_PostsServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param displetretsidx_Google_Post $postBody
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Post
     */
    public function insert($blogId, displetretsidx_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Post($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_PostList
     */
    public function search($blogId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new displetretsidx_Google_PostList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return displetretsidx_Google_Post
     */
    public function update($blogId, $postId, displetretsidx_Google_Post $postBody, $optParams = array()) {
     ...
     * @return displetretsidx_Google_Post
     */
    public function patch($blogId, $postId, displetretsidx_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class displetretsidx_Google_PagesServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @return displetretsidx_Google_PageList
     */
    public function listPages($blogId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_PageList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_Page
     */
    public function get($blogId, $pageId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_Page($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class displetretsidx_Google_UsersServiceResource extends displetretsidx_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return displetretsidx_Google_User
     */
    public function get($userId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new displetretsidx_Google_User($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for displetretsidx_Google_Blogger (v3).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class displetretsidx_Google_BloggerService extends displetretsidx_Google_Service {
  public $blogs;
  public $posts;
  public $pages;
  public $comments;
...
class displetretsidx_Google_Blog extends displetretsidx_Google_Model {
  ...
  public function setLocale(displetretsidx_Google_BlogLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setPosts(displetretsidx_Google_BlogPosts $posts) {
    $this->posts = $posts;
  }
  ...
  public function setPages(displetretsidx_Google_BlogPages $pages) {
    $this->pages = $pages;
  }
...
class displetretsidx_Google_BlogList extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Blog';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Blog) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Blog', __METHOD__);
    $this->items = $items;
  }
...
class displetretsidx_Google_BlogLocale extends displetretsidx_Google_Model {
  public $country;
  public $variant;
  public $language;
...
class displetretsidx_Google_BlogPages extends displetretsidx_Google_Model {
  public $totalItems;
  public $selfLink;
...
class displetretsidx_Google_BlogPosts extends displetretsidx_Google_Model {
  public $totalItems;
  protected $__itemsType = 'displetretsidx_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
  public $selfLink;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(displetretsidx_Google_Post) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Post', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Comment extends displetretsidx_Google_Model {
  ...
  public $inReplyTo;
  protected $__authorType = 'displetretsidx_Google_CommentAuthor';
  protected $__authorDataType = '';
  public $author;
  public $updated;
  protected $__blogType = 'displetretsidx_Google_CommentBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  protected $__postType = 'displetretsidx_Google_CommentPost';
  ...
  public function setAuthor(displetretsidx_Google_CommentAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setBlog(displetretsidx_Google_CommentBlog $blog) {
    $this->blog = $blog;
  }
  ...
  public function setPost(displetretsidx_Google_CommentPost $post) {
    $this->post = $post;
  }
...
class displetretsidx_Google_CommentAuthor extends displetretsidx_Google_Model {
  public $url;
  protected $__imageType = 'displetretsidx_Google_CommentAuthorImage';
  ...
  public function setImage(displetretsidx_Google_CommentAuthorImage $image) {
    $this->image = $image;
  }
...
class displetretsidx_Google_CommentAuthorImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_CommentBlog extends displetretsidx_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class displetretsidx_Google_CommentPost extends displetretsidx_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class displetretsidx_Google_Page extends displetretsidx_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'displetretsidx_Google_PageAuthor';
  protected $__authorDataType = '';
  public $author;
  public $url;
  public $title;
  public $updated;
  protected $__blogType = 'displetretsidx_Google_PageBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  public $id;
  ...
  public function setAuthor(displetretsidx_Google_PageAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  ...
  public function setBlog(displetretsidx_Google_PageBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
...
class displetretsidx_Google_PageAuthor extends displetretsidx_Google_Model {
  public $url;
  protected $__imageType = 'displetretsidx_Google_PageAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(displetretsidx_Google_PageAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class displetretsidx_Google_PageAuthorImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_PageBlog extends displetretsidx_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class displetretsidx_Google_PageList extends displetretsidx_Google_Model {
  protected $__itemsType = 'displetretsidx_Google_Page';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(displetretsidx_Google_Page) */ $items) {
    $this->assertIsArray($items, 'displetretsidx_Google_Page', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class displetretsidx_Google_Post extends displetretsidx_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'displetretsidx_Google_PostAuthor';
  protected $__authorDataType = '';
  public $author;
  protected $__repliesType = 'displetretsidx_Google_PostReplies';
  protected $__repliesDataType = '';
  public $replies;
  public $labels;
  public $customMetaData;
  public $updated;
  protected $__blogType = 'displetretsidx_Google_PostBlog';
  protected $__blogDataType = '';
  public $blog;
  public $url;
  protected $__locationType = 'displetretsidx_Google_PostLocation';
  ...
  public function setAuthor(displetretsidx_Google_PostAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  }
  public function setReplies(displetretsidx_Google_PostReplies $replies) {
    $this->replies = $replies;
  }
  public function getReplies() {
    return $this->replies;
  }
  public function setLabels(/* array(displetretsidx_Google_string) */ $labels) {
    $this->assertIsArray($labels, 'displetretsidx_Google_string', __METHOD__);
    $this->labels = $labels;
  }
  ...
  public function setBlog(displetretsidx_Google_PostBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
  ...
  public function setLocation(displetretsidx_Google_PostLocation $location) {
...
class displetretsidx_Google_PostAuthor extends displetretsidx_Google_Model {
  public $url;
  protected $__imageType = 'displetretsidx_Google_PostAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(displetretsidx_Google_PostAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class displetretsidx_Google_PostAuthorImage extends displetretsidx_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class displetretsidx_Google_PostBlog extends displetretsidx_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class displetretsidx_Google_PostList extends displetretsidx_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'displetretsidx_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
...
class displetretsidx_Google_PostLocation extends displetretsidx_Google_Model {
  public $lat;
  public $lng;
  public $span;
  public $name;
...
class displetretsidx_Google_PostReplies extends displetretsidx_Google_Model {
  public $totalItems;
  protected $__itemsType = 'displetretsidx_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class displetretsidx_Google_User extends displetretsidx_Google_Model {
  ...
  public $displayName;
  public $created;
  protected $__localeType = 'displetretsidx_Google_UserLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__blogsType = 'displetretsidx_Google_UserBlogs';
  ...
  public function setLocale(displetretsidx_Google_UserLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setBlogs(displetretsidx_Google_UserBlogs $blogs) {
    $this->blogs = $blogs;
  }
...
class displetretsidx_Google_UserBlogs extends displetretsidx_Google_Model {
  public $selfLink;
  public function setSelfLink($selfLink) {
    $this->selfLink = $selfLink;
  }
...
class displetretsidx_Google_UserLocale extends displetretsidx_Google_Model {
  public $country;
  public $variant;
  public $language;
  public function setCountry($country) {
