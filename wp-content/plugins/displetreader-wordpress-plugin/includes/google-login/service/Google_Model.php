 ...
 *
 */
class displetretsidx_Google_Model {
   ...
   * @throws displetretsidx_Google_Exception Thrown if $obj isn't an array.
  ...
  public function assertIsArray($obj, $type, $method) {
    if ($obj && !is_array($obj)) {
      throw new displetretsidx_Google_Exception("Incorrect parameter type passed to $method(), expected an"
