 ...
 */
class displetretsidx_Google_REST {
  /**
   ...
   *
   * @param displetretsidx_Google_HttpRequest $req
   * @return array decoded result
   * @throws displetretsidx_Google_ServiceException on server side error (ie: not authenticated,
   *  invalid or malformed post body, invalid url)
   */
  static public function execute(displetretsidx_Google_HttpRequest $req) {
    $httpRequest = displetretsidx_Google_Client::$io->makeRequest($req);
  ...
  static function createRequestUri($servicePath, $restPath, $params) {
    ...
    if (count($uriTemplateVars)) {
      $uriTemplateParser = new displetretsidx_URI_Template_Parser($requestUrl);
