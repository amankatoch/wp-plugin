 ...
 *
 */
class displetretsidx_Google_HttpRequest {
  ...
  public function __construct($url, $method = 'GET', $headers = array(), $postBody = null) {
    ...
    if (empty($displetretsidx_apiConfig['application_name'])) {
      $this->userAgent = self::USER_AGENT_SUFFIX;
    } else {
      $this->userAgent = $displetretsidx_apiConfig['application_name'] . " " . self::USER_AGENT_SUFFIX;
    }
  }
  ...
  public function setResponseHeaders($headers) {
    $headers = displetretsidx_Google_Utils::normalize($headers);
  ...
  public function setUrl($url) {
    if (substr($url, 0, 4) == 'http') {
      ...
      global $displetretsidx_apiConfig;
      $this->url = $displetretsidx_apiConfig['basePath'] . $url;
    }
  }
