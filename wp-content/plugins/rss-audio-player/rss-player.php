...

{
	...
	$short .= " <div class='rssplayer_table'>";
	...
	if(get_post_meta( '1', 'rss_player_title_icon', true ))
	{
     ...
     $image_attributes= wp_get_attachment_image_src( $image_id, array(32,32),false );
 	 ...
 	 $short .="<a href=''> <img src='".$image_attributes[0]."' width='" . $image_attributes[1]."' height='" . $image_attributes[2]. "'></a>";
...

	{
		...
		if ($xmlid % 2 == 0)
			$short .= "<div class='programText'>";
		else
			
		$short .= "<div class='programText'>";
		$short .= "<ul><li class='playcol'>";
		...
		$short .= "<a title='Display Player' href=javascript:showPlayer('".$xmlid."');>";
		$short .= "<img class=play src=".plugin_dir_url( __FILE__ )."images/play.png border=0></a></li>";
		$short .= "<li class='titlecol'>";
		$short .= "<a href=#>".$xmltitle."</a></li>";
		$short .= " <li><div class='datecol'>";

		$short .= "<div class=podcast-date>".$newDate."&nbsp;</div>";
		$short .="</div>";
        $short .=" <div class='socialcol'><div class='social-icons'>";
		...
		$short .= "<a class='prevent_showPop' title='Share on Google +' href=https://plus.google.com/share?url=".get_the_permalink()."><img class=google src=".plugin_dir_url( __FILE__ )."images/google.png border=0></a>";
		
		$short .= "<a class='prevent_showPop' title='Share on Twitter' href=http://twitter.com/share?url=".get_the_permalink()."><img class=twitterr src=".plugin_dir_url( __FILE__ )."images/twitter.png border=0></a>";
		
		$short .= "<a class='prevent_showPop' title='Share on Facebook' href=http://www.facebook.com/sharer.php?u=".get_the_permalink()."><img class=facebook src=".plugin_dir_url( __FILE__ )."images/fb.png border=0></a>";
        ...
        $short.= '<div class="pop-up" id="pop1'.$xmlid.'">
        <!-- The pop-up block -->
        <div class="popBox">
      ...
      $iframe_data='<textarea class=popsj><iframe src='.plugin_dir_url( __FILE__ ).'iframe.php?id='.$xmlid.' width=100% height=696 frameborder=0> </iframe></textarea>';
		...
		$short.="<audio id=audioPlayer".$xmlid." src=".$xmlmedia." type=audio/mpeg  controls></audio></div></div>";
	}
