...
function ShowMessage_Form(id) {
 ...
 modalWin.ShowMessage("<div id='viewJob"+id+"'><form class='form-table form-horizontal' id='mail_form' name='mail_form' method='post' >"+
        ""+
        ""+     
        ...
        "<div class='input-box '><input class='form-control' type='text' name='fromEmail' id='fromEmail"+id+"'></div></div>"+
        ""+
        ""+     
        ""+
        "<div class='form-group'>"+
                ...
                "</label>"+
        ""+
        "<div class='input-box '><input  type='text' name='toEmail' id='toEmail"+id+"'></div></div>"+
        ""+
        ""+
        "<div class='form-group'>"+
                "<label class='control-label' for='inputSuccess'>"+
                ...
                "</label>"+
        ""+
        "<div class='input-box '><input type='text' name='subject' id='subject"+id+"' value='Check this out!'></div></div>"+
        ""+
        ""+
         "<div class='form-group'>"+
                "<label class='control-label' for='inputSuccess'>"+
                ...
                "</label>"+
        ""+
        "<div class='input-box '><textarea id='briteWrox_comment"+id+"' class='textBody'  name='comments'></textarea>"+
        ""+
        ""+    
        ""+
        ""+
        "<input id='mail_link"+id+"' type='hidden' value='"+id+"' >"+
        "<input type='hidden' name='hide_email' value="+url+" id='plugUrl"+id+"'/>"+
        "<input type='hidden' name='shareUrl' value='"+link+"'/ >"+
        "<input class='mailSend button' onclick='sendmail("+id+")' type='button' value='Send' >"+
        ""+
        ""+
        ""+
        ""+
